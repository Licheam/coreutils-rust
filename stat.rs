...
pub const PRINTF_OPTION: C2RustUnnamed_1 = 128;
    ...
    match m as libc::c_int {
        ...
        111 => {
            out_uint(
                pformat,
                prefix_len,
                (if (0 as libc::c_int as libc::c_long) < (*statbuf).st_blksize
...
unsafe extern "C" fn out_file_context(
    ...
    if (if follow_links as libc::c_int != 0 {
        rpl_getfilecon(filename, &mut scontext)
    } else {
        rpl_lgetfilecon(filename, &mut scontext)
    }) < 0 as libc::c_int
    {
        error(
            0 as libc::c_int,
...
unsafe extern "C" fn out_mount_point(
            ...
            == 0o120000 as libc::c_int as libc::c_uint)
    {
        ...
        if resolved.is_null() {
            ...
            current_block = 17534284782087369071;
        } else {
            ...
            37 => {
                ...
                match fmt_char as libc::c_int {
                    0 => {
                        b = b.offset(-1);
                        b;
                        current_block_20 = 10946326428192611759;
                    }
                    37 => {
                        current_block_20 = 10946326428192611759;
                    }
                    72 | 76 => {
                        ...
                        current_block_20 = 10205258310783614638;
                    }
                    _ => {
                        current_block_20 = 10205258310783614638;
                    }
    ...
    if fd < 0 as libc::c_int {
        if flags & 0x1000 as libc::c_int != 0 {
            ...
            error(
                0 as libc::c_int,
                *__errno_location(),
                gettext(b"cannot statx %s\0" as *const u8 as *const libc::c_char),
                quotearg_style(shell_escape_always_quoting_style, filename),
            );
        }
        return 0 as libc::c_int != 0;
