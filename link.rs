...
pub unsafe extern "C" fn usage(mut status: libc::c_int) -> ! {
    if status != 0 as libc::c_int {
        ...
        fputs_unlocked(
            gettext(
                b"Call the link function to create a link named FILE2 to an existing FILE1.\n\n\0"
        ...
        emit_ancillary_info(b"link\0" as *const u8 as *const libc::c_char);
    }
    exit(status);
}
#[inline]
    ...
    ) != 0 as libc::c_int
    {
        if ::core::mem::size_of::<C2RustUnnamed>() as libc::c_ulong != 0 {
            error(
                ...
                *__errno_location(),
                gettext(
                    b"cannot create link %s to %s\0" as *const u8 as *const libc::c_char,
                ),
                quotearg_n_style(
                    0 as libc::c_int,
