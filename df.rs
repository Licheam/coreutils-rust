...
pub const OUTPUT_OPTION: C2RustUnnamed_4 = 131;
pub const TOTAL_OPTION: C2RustUnnamed_4 = 130;
pub const SYNC_OPTION: C2RustUnnamed_4 = 129;
pub const NO_SYNC_OPTION: C2RustUnnamed_4 = 128;
#[derive(Copy, Clone)]
#[repr(C)]
...
unsafe extern "C" fn alloc_field(mut f: libc::c_int, mut c: *const libc::c_char) {
    ...
    let ref mut fresh2 = *columns
        .offset(ncolumns.wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize);
    *fresh2 = &mut *field_data.as_mut_ptr().offset(f as isize) as *mut field_data_t;
    if !c.is_null() {
...
unsafe extern "C" fn get_field_list() {
    match header_mode {
        ...
        _ => {
            ...
            'c_12806: {
                if (b"invalid header_mode\0" as *const u8 as *const libc::c_char)
                    .is_null()
                {} else {
                    __assert_fail(
                        b"!\"invalid header_mode\"\0" as *const u8
                            as *const libc::c_char,
                        b"src/df.c\0" as *const u8 as *const libc::c_char,
                        570 as libc::c_int as libc::c_uint,
                        (*::core::mem::transmute::<
...
unsafe extern "C" fn get_header() {
    ...
    while col < ncolumns {
        ...
        let mut header: *const libc::c_char = gettext(
                    ...
                    && human_output_opts & human_autoscale as libc::c_int == 0)
        {
            ...
            header = gettext(b"blocks\0" as *const u8 as *const libc::c_char);
            if rpl_asprintf(
                &mut cell as *mut *mut libc::c_char,
                gettext(b"%s-%s\0" as *const u8 as *const libc::c_char),
                num,
                header,
            ) == -(1 as libc::c_int)
            {
...
unsafe extern "C" fn devlist_free(mut p: *mut libc::c_void) {
    free(p);
}
unsafe extern "C" fn filter_mount_list(mut devices_only: bool) {
    ...
    devlist_table = hash_initialize(
        ...
        Some(devlist_free as unsafe extern "C" fn(*mut libc::c_void) -> ()),
    );
    if devlist_table.is_null() {
        xalloc_die();
    }
    ...
    while col < ncolumns {
        ...
        match (**columns.offset(col as isize)).field_type as libc::c_uint {
            ...
            _ => {
                ...
                'c_15532: {
                    if (b"bad field_type\0" as *const u8 as *const libc::c_char)
                        .is_null()
                    {} else {
                        __assert_fail(
                            b"!\"bad field_type\"\0" as *const u8 as *const libc::c_char,
        ...
        match (**columns.offset(col as isize)).field as libc::c_uint {
            ...
            _ => {
                ...
                'c_15017: {
                    if (b"unhandled field\0" as *const u8 as *const libc::c_char)
                        .is_null()
                    {} else {
                        __assert_fail(
                            b"!\"unhandled field\"\0" as *const u8
                                as *const libc::c_char,
                            b"src/df.c\0" as *const u8 as *const libc::c_char,
                            1264 as libc::c_int as libc::c_uint,
                            (*::core::mem::transmute::<
        ...
        if cell.is_null() {
            ...
            'c_14962: {
                if (b"empty cell\0" as *const u8 as *const libc::c_char).is_null()
                {} else {
                    __assert_fail(
                        b"!\"empty cell\"\0" as *const u8 as *const libc::c_char,
                        b"src/df.c\0" as *const u8 as *const libc::c_char,
...
unsafe fn main_0(
    ...
    let mut msg_mut_excl: *const libc::c_char = gettext(
        b"options %s and %s are mutually exclusive\0" as *const u8 as *const libc::c_char,
    );
    loop {
    ...
    if mount_list.is_null() {
        ...
        let mut warning: *const libc::c_char = if status == 0 as libc::c_int {
            gettext(b"Warning: \0" as *const u8 as *const libc::c_char)
                as *const libc::c_char
        } else {
            b"\0" as *const u8 as *const libc::c_char
        };
