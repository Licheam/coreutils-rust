...
pub const HEADER_LINE_OPTION: C2RustUnnamed_2 = 130;
pub const NOCHECK_ORDER_OPTION: C2RustUnnamed_2 = 129;
pub const CHECK_ORDER_OPTION: C2RustUnnamed_2 = 128;
#[derive(Copy, Clone)]
#[repr(C)]
...
unsafe extern "C" fn keycmp(
    ...
    return if len1 < len2 { -(1 as libc::c_int) } else { (len1 != len2) as libc::c_int };
}
...
unsafe extern "C" fn add_field(mut file: libc::c_int, mut field: size_t) {
    ...
    'c_9785: {
        if file != 0 as libc::c_int || field == 0 as libc::c_int as libc::c_ulong
        {} else {
            __assert_fail(
                b"file != 0 || field == 0\0" as *const u8 as *const libc::c_char,
                b"src/join.c\0" as *const u8 as *const libc::c_char,
    ...
    if n == 2 as libc::c_int {
        ...
        if !op0 {
            *operand_status
            ...
            let ref mut fresh9 = *names.offset(0 as libc::c_int as isize);
            *fresh9 = *names.offset(1 as libc::c_int as isize);
        }
        n = 1 as libc::c_int;
    }
    *operand_status.offset(n as isize) = *prev_optc_status;
    let ref mut fresh10 = *names.offset(n as isize);
    *fresh10 = name;
    ...
    loop {
        ...
        match optc {
            118 => {
                ...
                current_block_60 = 1206334828063250803;
            }
            97 => {
                current_block_60 = 1206334828063250803;
            }
            101 => {
                ...
                empty_filler = optarg;
                current_block_60 = 17836213544692497527;
            }
            105 => {
