...
pub const GETOPT_VERSION_CHAR: C2RustUnnamed_3 = -131;
pub const GETOPT_HELP_CHAR: C2RustUnnamed_3 = -130;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct infomap {
...
pub const ST_TERMYES: C2RustUnnamed_4 = 1;
pub type C2RustUnnamed_4 = libc::c_uint;
pub const ST_GLOBAL: C2RustUnnamed_4 = 3;
pub const ST_TERMSURE: C2RustUnnamed_4 = 2;
pub const ST_TERMNO: C2RustUnnamed_4 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
        ...
        match *str as libc::c_int {
            ...
            58 | 61 => {
                if need_backslash {
                    ...
                    let fresh3 = (*__o_2).next_free;
                    (*__o_2).next_free = ((*__o_2).next_free).offset(1);
                    *fresh3 = '\\' as i32 as libc::c_char;
                }
                current_block_24 = 8597530218446132501;
            }
            _ => {
                current_block_24 = 8597530218446132501;
            }
...
unsafe extern "C" fn dc_parse_stream(
    ...
    let mut state: C2RustUnnamed_4 = ST_GLOBAL;
    ...
    loop {
        ...
        if arg.is_null() {
            ...
            if c_strcasecmp(keywd, b"TERM\0" as *const u8 as *const libc::c_char)
                == 0 as libc::c_int
            {
                if fnmatch(arg, term, 0 as libc::c_int) == 0 as libc::c_int {
                    state = ST_TERMSURE;
                } else if state as libc::c_uint
                    != ST_TERMSURE as libc::c_int as libc::c_uint
                {
                    state = ST_TERMNO;
                }
            } else {
                ...
                if state as libc::c_uint != ST_TERMNO as libc::c_int as libc::c_uint {
                        ...
                        ) == 0 as libc::c_int)
                    {
                        ...
                        if !(slack_codes[i as usize]).is_null() {
                            let mut __o_4: *mut obstack = &mut lsc_obstack;
                            if ({
                            ...
                            let fresh10 = (*__o_4).next_free;
                            (*__o_4).next_free = ((*__o_4).next_free).offset(1);
                            *fresh10 = *(ls_codes[i as usize])
                                .offset(0 as libc::c_int as isize);
                            let mut __o_5: *mut obstack = &mut lsc_obstack;
                            if ({
                            ...
                            let fresh11 = (*__o_5).next_free;
                            (*__o_5).next_free = ((*__o_5).next_free).offset(1);
                            *fresh11 = *(ls_codes[i as usize])
                                .offset(1 as libc::c_int as isize);
                            let mut __o_6: *mut obstack = &mut lsc_obstack;
                            if ({
                        ...
                        == ST_TERMYES as libc::c_int as libc::c_uint)
            {
                error(
                    ...
                    if !filename.is_null() {
                        ...
                        gettext(b"<internal>\0" as *const u8 as *const libc::c_char)
                    },
                    line_number,
                    keywd,
                );
...
unsafe fn main_0(
    ...
    if print_database as libc::c_int != 0
        && syntax as libc::c_uint != SHELL_SYNTAX_UNKNOWN as libc::c_int as libc::c_uint
    {
        error(
            ...
            0 as libc::c_int,
            gettext(
                b"the options to output dircolors' internal database and\nto select a shell syntax are mutually exclusive\0"
                    as *const u8 as *const libc::c_char,
            ),
        );
        usage(1 as libc::c_int);
