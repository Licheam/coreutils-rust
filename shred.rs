...
pub const RANDOM_SOURCE_OPTION: C2RustUnnamed_5 = 128;
#[derive(Copy, Clone)]
#[repr(C)]
...
unsafe extern "C" fn dosync(
    ...
    if !ignorable_sync_errno(err) {
        error(
            0 as libc::c_int,
            err,
            gettext(b"%s: fdatasync failed\0" as *const u8 as *const libc::c_char),
            qname,
        );
    ...
    if !ignorable_sync_errno(err) {
        error(
            0 as libc::c_int,
            err,
            gettext(b"%s: fsync failed\0" as *const u8 as *const libc::c_char),
            qname,
        );
        *__errno_location() = err;
        return -(1 as libc::c_int);
...
unsafe extern "C" fn direct_mode(mut fd: libc::c_int, mut enable: bool) {
    ...
    if (0 as libc::c_int) < fd_flags {
        let mut new_flags: libc::c_int = if enable as libc::c_int != 0 {
            fd_flags | 0o40000 as libc::c_int
        } else {
            fd_flags & !(0o40000 as libc::c_int)
        };
...
unsafe extern "C" fn dopass(
    ...
    let mut fill_pattern_mem: *mut libc::c_void = xmalloc(
        page_size
            .wrapping_sub(1 as libc::c_int as libc::c_ulong)
            .wrapping_add(
                output_size
    ...
    let mut pbuf: *mut libc::c_uchar = ptr_align(fill_pattern_mem, page_size)
        as *mut libc::c_uchar;
    ...
    if !dorewind(fd, st) {
        error(
            0 as libc::c_int,
            *__errno_location(),
            gettext(b"%s: cannot rewind\0" as *const u8 as *const libc::c_char),
            qname,
        );
        ...
        's_108: loop {
                        ...
                        || *__errno_location() == 28 as libc::c_int)
                {
                    ...
                    if !try_without_directio && *__errno_location() == 22 as libc::c_int
                    {
                        ...
                        match current_block {
                            ...
                            _ => {
                                other_error = 1 as libc::c_int != 0;
                                current_block = 7972734587852795191;
                                break 's_108;
                            }
                        }
                    }
            ...
            }) - offset) as libc::c_ulong) < soff
            {
                error(
                    0 as libc::c_int,
                    0 as libc::c_int,
                    gettext(b"%s: file too large\0" as *const u8 as *const libc::c_char),
                    qname,
                );
                other_error = 1 as libc::c_int != 0;
                current_block = 7972734587852795191;
...
unsafe extern "C" fn do_wipefd(
    ...
    if fstat(fd, &mut st) != 0 {
        error(
            0 as libc::c_int,
            *__errno_location(),
            gettext(b"%s: fstat failed\0" as *const u8 as *const libc::c_char),
            qname,
        );
        return 0 as libc::c_int != 0;
    }
            ...
            == 0o140000 as libc::c_int as libc::c_uint
    {
        error(
            0 as libc::c_int,
            0 as libc::c_int,
            gettext(b"%s: invalid file type\0" as *const u8 as *const libc::c_char),
            qname,
        );
        return 0 as libc::c_int != 0;
        ...
        && st.st_size < 0 as libc::c_int as libc::c_long
    {
        error(
            0 as libc::c_int,
            0 as libc::c_int,
            gettext(b"%s: file has negative size\0" as *const u8 as *const libc::c_char),
            qname,
        );
        return 0 as libc::c_int != 0;
    }
    ...
    if size == -(1 as libc::c_int) as libc::c_long {
            ...
            == 0o100000 as libc::c_int as libc::c_uint
        {
            ...
            if !(*flags).exact {
                ...
                if remainder != 0 as libc::c_int as libc::c_long {
                    let mut size_incr: off_t = (if (0 as libc::c_int as libc::c_long)
                        < st.st_blksize
                        && st.st_blksize as libc::c_ulong
                            <= (-(1 as libc::c_int) as size_t)
                                .wrapping_div(8 as libc::c_int as libc::c_ulong)
        ...
        == 0o100000 as libc::c_int as libc::c_uint
        && st.st_size
            < (if (if (0 as libc::c_int as libc::c_long) < st.st_blksize
                && st.st_blksize as libc::c_ulong
                    <= (-(1 as libc::c_int) as size_t)
                        .wrapping_div(8 as libc::c_int as libc::c_ulong)
                        .wrapping_add(1 as libc::c_int as libc::c_ulong)
            ...
            < ((*flags).n_iterations).wrapping_add((*flags).zero_fill as libc::c_ulong)
        {
            ...
            if err != 0 {
                ...
                if err < 0 as libc::c_int {
                    current_block = 16511925192375488289;
                    break 's_166;
                }
            }
            i = i.wrapping_add(1);
...
unsafe extern "C" fn wipefd(
    ...
    if fd_flags < 0 as libc::c_int {
        error(
            0 as libc::c_int,
            *__errno_location(),
            gettext(b"%s: fcntl failed\0" as *const u8 as *const libc::c_char),
            qname,
        );
        return 0 as libc::c_int != 0;
    }
...
unsafe extern "C" fn wipename(
    ...
    if (*flags).verbose {
        error(
            0 as libc::c_int,
            0 as libc::c_int,
            gettext(b"%s: removing\0" as *const u8 as *const libc::c_char),
            qoldname,
        );
    }
    if (*flags).remove_file as libc::c_uint
    ...
    if unlink(oldname) != 0 as libc::c_int {
        error(
            0 as libc::c_int,
            *__errno_location(),
            gettext(b"%s: failed to remove\0" as *const u8 as *const libc::c_char),
            qoldname,
        );
        ok = 0 as libc::c_int != 0;
        ...
        error(
            0 as libc::c_int,
            0 as libc::c_int,
            gettext(b"%s: removed\0" as *const u8 as *const libc::c_char),
            qoldname,
        );
    }
    if 0 as libc::c_int <= dir_fd {
        ...
        if close(dir_fd) != 0 as libc::c_int {
            error(
                0 as libc::c_int,
                *__errno_location(),
                gettext(b"%s: failed to close\0" as *const u8 as *const libc::c_char),
                qdir,
            );
            ok = 0 as libc::c_int != 0;
        }
        ...
        match c {
            ...
            110 => {
                flags
                    ...
                    b"\0" as *const u8 as *const libc::c_char,
                    gettext(
                        b"invalid number of passes\0" as *const u8 as *const libc::c_char,
                    ),
                    0 as libc::c_int,
                );
            }
            ...
            115 => {
                flags
                    ...
                    b"cbBkKMGTPEZY0\0" as *const u8 as *const libc::c_char,
                    gettext(b"invalid file size\0" as *const u8 as *const libc::c_char),
                    0 as libc::c_int,
                ) as off_t;
            }
            118 => {
