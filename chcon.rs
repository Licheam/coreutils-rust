...
pub const REFERENCE_FILE_OPTION: C2RustUnnamed_1 = 131;
pub const PRESERVE_ROOT: C2RustUnnamed_1 = 130;
pub const NO_PRESERVE_ROOT: C2RustUnnamed_1 = 129;
pub const DEREFERENCE_OPTION: C2RustUnnamed_1 = 128;
#[derive(Copy, Clone)]
#[repr(C)]
...
unsafe extern "C" fn change_file_context(
    ...
    let mut context: context_t = 0 as *mut context_s_t;
...
unsafe fn main_0(
    ...
    if !reference_file.is_null() {
        ...
        if rpl_getfilecon(reference_file, &mut ref_context) < 0 as libc::c_int {
        ...
        if (0 as libc::c_int) < is_selinux_enabled()
