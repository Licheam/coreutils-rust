...
pub const IGNORE_OPTION: C2RustUnnamed_0 = 129;
pub const ALL_OPTION: C2RustUnnamed_0 = 128;
#[no_mangle]
pub unsafe extern "C" fn usage(mut status: libc::c_int) -> ! {
    if status != 0 as libc::c_int {
        ...
        fputs_unlocked(
            gettext(
                b"      --all      print the number of installed processors\n      --ignore=N  if possible, exclude N processing units\n\0"
                    as *const u8 as *const libc::c_char,
            ),
            stdout,
        );
        ...
        emit_ancillary_info(b"nproc\0" as *const u8 as *const libc::c_char);
    }
    exit(status);
}
#[inline]
...
static mut longopts: [option; 5] = [
    ...
    },
    {
        let mut init = option {
            ...
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: IGNORE_OPTION as libc::c_int,
        };
        init
    },
    {
...
unsafe fn main_0(
    ...
    let mut nproc: libc::c_ulong = 0;
    let mut ignore: libc::c_ulong = 0 as libc::c_int as libc::c_ulong;
    ...
    let mut mode: nproc_query = NPROC_CURRENT_OVERRIDABLE;
    loop {
        ...
        match c {
            ...
            -131 => {
                version_etc(
                    stdout,
                    b"nproc\0" as *const u8 as *const libc::c_char,
                    b"GNU coreutils\0" as *const u8 as *const libc::c_char,
                    Version,
    ...
    if ignore < nproc {
        ...
        nproc = 1 as libc::c_int as libc::c_ulong;
    }
    printf(b"%lu\n\0" as *const u8 as *const libc::c_char, nproc);
