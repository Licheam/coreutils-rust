...
unsafe fn main_0(
        ...
        .offset(0 as libc::c_int as isize) as libc::c_int
    {
        98 => {
            ...
            current_block = 9270956894012175335;
        }
        99 | 117 => {
        ...
        _ => {
            error(
                0 as libc::c_int,
                0 as libc::c_int,
                gettext(b"invalid device type %s\0" as *const u8 as *const libc::c_char),
            ...
            if device == -(1 as libc::c_int) as dev_t {
                if ::core::mem::size_of::<C2RustUnnamed_3>() as libc::c_ulong != 0 {
                    error(
                        ...
                        0 as libc::c_int,
                        gettext(
                            b"invalid device %s %s\0" as *const u8 as *const libc::c_char,
                        ),
                        s_major,
                        s_minor,
                    );
