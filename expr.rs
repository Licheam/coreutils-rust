...
unsafe extern "C" fn mbuiter_multi_next(mut iter: *mut mbuiter_multi) {
    ...
    if (*iter).in_shift {
        current_block = 998588590983772469;
            ...
            if iter.cur.bytes == 1 as libc::c_int as libc::c_ulong {
                ...
                loop {
                    ...
                    if !(!(aiter.cur.wc_valid as libc::c_int != 0
                        && aiter.cur.wc == 0 as libc::c_int) as libc::c_int != 0)
                    {
                        break;
                    }
...
unsafe extern "C" fn docolon(mut sv: *mut VALUE, mut pv: *mut VALUE) -> *mut VALUE {
    ...
    rpl_re_syntax_options = (((1 as libc::c_int as libc::c_ulong) << 1 as libc::c_int)
        ...
        & !(((((((((((((((((1 as libc::c_int as libc::c_ulong) << 1 as libc::c_int)
            ...
            << 1 as libc::c_int) << 1 as libc::c_int) << 1 as libc::c_int)
            << 1 as libc::c_int) << 1 as libc::c_int) << 1 as libc::c_int);
    errmsg = rpl_re_compile_pattern((*pv).u.s, strlen((*pv).u.s), &mut re_buffer);
    if !errmsg.is_null() {
    ...
    if 0 as libc::c_int as libc::c_long <= matchlen {
        if re_buffer.re_nsub > 0 as libc::c_int as libc::c_ulong {
            if *(re_regs.end).offset(1 as libc::c_int as isize)
    ...
    } else if matchlen == -(1 as libc::c_int) as libc::c_long {
        if re_buffer.re_nsub > 0 as libc::c_int as libc::c_ulong {
            v = str_value(b"\0" as *const u8 as *const libc::c_char);
        } else {
            ...
            if !toarith(l) || !toarith(r) {
                if ::core::mem::size_of::<C2RustUnnamed_9>() as libc::c_ulong != 0 {
                    error(
                        ...
                        0 as libc::c_int,
                        gettext(
                            b"non-integer argument\0" as *const u8 as *const libc::c_char,
                        ),
                    );
                    if 0 as libc::c_int != 0 {} else {
                        unreachable!();
...
pub fn main() {
    let mut _args: Vec::<*mut libc::c_char> = Vec::new();
    ...
    _args.push(::core::ptr::null_mut());
    unsafe {
        ::std::process::exit(
            main_0(
                (_args.len() - 1) as libc::c_int,
                _args.as_mut_ptr() as *mut *mut libc::c_char,
            ) as i32,
        )
    }
}
