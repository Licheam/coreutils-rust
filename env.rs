...
pub const LIST_SIGNAL_HANDLING_OPTION: C2RustUnnamed_12 = 131;
pub const BLOCK_SIGNAL_OPTION: C2RustUnnamed_12 = 130;
pub const IGNORE_SIGNAL_OPTION: C2RustUnnamed_12 = 129;
pub const DEFAULT_SIGNAL_OPTION: C2RustUnnamed_12 = 128;
#[derive(Copy, Clone)]
#[repr(C)]
        ...
        if unsetenv(*usvars.offset(i as isize)) != 0 {
            if ::core::mem::size_of::<C2RustUnnamed_13>() as libc::c_ulong != 0 {
                error(
                    ...
                    *__errno_location(),
                    gettext(b"cannot unset %s\0" as *const u8 as *const libc::c_char),
    ...
    *fresh5 = 0 as *mut libc::c_char;
    loop {
        ...
        match *str as libc::c_int {
            ...
            35 => {
                if ss.sep {
                    current_block = 12977505020959025596;
                    break;
                }
            }
            92 => {
                        ...
                        != '\'' as i32)
                {
                    ...
                    match newc as libc::c_int {
                        34 | 35 | 36 | 39 | 92 => {}
                        95 => {
                            current_block = 11357478949582428591;
                            match current_block {
                                11357478949582428591 => {
                                    if !dq {
                                        str = str.offset(1);
                                        str;
                                        ss.sep = 1 as libc::c_int != 0;
                                ...
                                17279661178440451056 => {
                                    newc = '\u{b}' as i32 as libc::c_char;
                                    current_block = 9241535491006583629;
                                }
                                15041698016135398161 => {
                                    ...
                                    current_block = 12631869541799334652;
                                }
                                _ => {}
                            }
                            match current_block {
                        ...
                        99 => {
                            current_block = 10460194452510699449;
                            match current_block {
                                11357478949582428591 => {
                                    if !dq {
                                        str = str.offset(1);
                        ...
                        102 => {
                            current_block = 3242353705986254766;
                            match current_block {
                                11357478949582428591 => {
                                    if !dq {
                                        str = str.offset(1);
                        ...
                        110 => {
                            current_block = 3246696440823151369;
                            match current_block {
                                11357478949582428591 => {
                                    if !dq {
                                        str = str.offset(1);
                        ...
                        116 => {
                            current_block = 2918449910738245635;
                            match current_block {
                                11357478949582428591 => {
                                    if !dq {
                                        str = str.offset(1);
                        ...
                        118 => {
                            current_block = 17279661178440451056;
                            match current_block {
                                11357478949582428591 => {
                                    if !dq {
                                        str = str.offset(1);
                        ...
                        0 => {
                            current_block = 15041698016135398161;
                            match current_block {
                                11357478949582428591 => {
                                    if !dq {
                                        str = str.offset(1);
            ...
            *eq = '\0' as i32 as libc::c_char;
            if ::core::mem::size_of::<C2RustUnnamed_25>() as libc::c_ulong != 0 {
                error(
                    EXIT_CANCELED as libc::c_int,
                    *__errno_location(),
                    gettext(b"cannot set %s\0" as *const u8 as *const libc::c_char),
