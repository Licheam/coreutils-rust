...
pub const PAGES_OPTION: C2RustUnnamed_9 = 129;
pub const COLUMNS_OPTION: C2RustUnnamed_9 = 128;
#[derive(Copy, Clone)]
#[repr(C)]
...
unsafe extern "C" fn print_stored(mut p: *mut COLUMN) -> bool {
    let mut q: *mut COLUMN = 0 as *mut COLUMN;
    let fresh6 = (*p).current_line;
    (*p).current_line = (*p).current_line + 1;
    let mut line: libc::c_int = fresh6;
...
unsafe extern "C" fn open_file(mut name: *mut libc::c_char, mut p: *mut COLUMN) -> bool {
    if strcmp(name, b"-\0" as *const u8 as *const libc::c_char) == 0 as libc::c_int {
        (*p).name = gettext(b"standard input\0" as *const u8 as *const libc::c_char);
        (*p).fp = stdin;
...
unsafe extern "C" fn print_header() {
    ...
    if page_number == 0 as libc::c_int as libc::c_ulong {
        if ::core::mem::size_of::<C2RustUnnamed_3>() as libc::c_ulong != 0 {
            error(
                1 as libc::c_int,
                0 as libc::c_int,
                gettext(b"page number overflow\0" as *const u8 as *const libc::c_char),
            );
    ...
    sprintf(
        ...
        gettext(b"Page %lu\0" as *const u8 as *const libc::c_char),
        page_number,
    );
...
unsafe extern "C" fn add_line_number(mut p: *mut COLUMN) {
    ...
    while i > 0 as libc::c_int {
        let fresh8 = s;
        s = s.offset(1);
        ((*p).char_func).expect("non-null function pointer")(*fresh8);
        i -= 1;
        i;
    }
...
unsafe extern "C" fn getoptarg(
    ...
    if *arg != 0 {
        ...
        if xstrtol(
            ...
            || tmp_long <= 0 as libc::c_int as libc::c_long
            || (2147483647 as libc::c_int as libc::c_long) < tmp_long
        {
            error(
                0 as libc::c_int,
                if (2147483647 as libc::c_int as libc::c_long) < tmp_long {
                    75 as libc::c_int
                } else {
                    *__errno_location()
                },
...
unsafe extern "C" fn init_parameters(mut number_of_files: libc::c_int) {
        ...
        == ::core::mem::size_of::<libc::c_schar>() as libc::c_ulong
    {
        if !((0 as libc::c_int) < -(1 as libc::c_int)) {
            if if col_sep_length < 0 as libc::c_int {
                if (columns - 1 as libc::c_int) < 0 as libc::c_int {
                    ...
                    }) - 1 as libc::c_int) < 0 as libc::c_int
                    {
                        ((columns - 1 as libc::c_int)
                            < 127 as libc::c_int / col_sep_length) as libc::c_int
                    } else {
                        ...
                        }) != 0
                        {
                            ...
                            127 as libc::c_int / -col_sep_length
                ...
                }) != 0 && col_sep_length == -(1 as libc::c_int)
                {
                    ...
                    ((-(127 as libc::c_int) - 1 as libc::c_int) / col_sep_length
                        < columns - 1 as libc::c_int) as libc::c_int
                }
            } else if col_sep_length == 0 as libc::c_int {
                0 as libc::c_int
            } else if (columns - 1 as libc::c_int) < 0 as libc::c_int {
                if (if (if ((if 1 as libc::c_int != 0 {
                    0 as libc::c_int
                } else {
                    (if 1 as libc::c_int != 0 {
                ...
                }) != 0 && columns - 1 as libc::c_int == -(1 as libc::c_int)
                {
                    ...
                    ((-(127 as libc::c_int) - 1 as libc::c_int)
                        / (columns - 1 as libc::c_int) < col_sep_length) as libc::c_int
                }
            } else {
                (127 as libc::c_int / col_sep_length < columns - 1 as libc::c_int)
                    as libc::c_int
            } != 0
            {
                sep_chars = ((columns - 1 as libc::c_int) as libc::c_uint)
                    .wrapping_mul(col_sep_length as libc::c_uint) as libc::c_schar
                    as libc::c_int;
                1 as libc::c_int
            } else {
                sep_chars = ((columns - 1 as libc::c_int) as libc::c_uint)
        ...
        } else if if col_sep_length < 0 as libc::c_int {
            if (columns - 1 as libc::c_int) < 0 as libc::c_int {
                if ((if 1 as libc::c_int != 0 {
                    0 as libc::c_int
                } else {
            ...
            }) != 0 && col_sep_length == -(1 as libc::c_int)
            {
                ...
                {
                    ((0 as libc::c_int) < columns - 1 as libc::c_int + 0 as libc::c_int)
                        as libc::c_int
                } else {
                    ((0 as libc::c_int) < columns - 1 as libc::c_int
                        && (-(1 as libc::c_int) - 0 as libc::c_int)
            ...
            }) != 0 && columns - 1 as libc::c_int == -(1 as libc::c_int)
            {
                ...
                (0 as libc::c_int / (columns - 1 as libc::c_int) < col_sep_length)
                    as libc::c_int
            }
        } else {
            ((127 as libc::c_int * 2 as libc::c_int + 1 as libc::c_int) / col_sep_length
                < columns - 1 as libc::c_int) as libc::c_int
        } != 0
        {
            sep_chars = ((columns - 1 as libc::c_int) as libc::c_uint)
                .wrapping_mul(col_sep_length as libc::c_uint) as libc::c_uchar
                as libc::c_int;
            1 as libc::c_int
        } else {
            sep_chars = ((columns - 1 as libc::c_int) as libc::c_uint)
        ...
        == ::core::mem::size_of::<libc::c_short>() as libc::c_ulong
    {
        if !((0 as libc::c_int) < -(1 as libc::c_int)) {
            if if col_sep_length < 0 as libc::c_int {
                if (columns - 1 as libc::c_int) < 0 as libc::c_int {
                    ...
                    {
                        ((columns - 1 as libc::c_int)
                            < 32767 as libc::c_int / col_sep_length) as libc::c_int
                    } else {
                        ((if (if (if ((if 1 as libc::c_int != 0 {
                            0 as libc::c_int
                        } else {
                        ...
                        }) != 0
                        {
                            ...
                            32767 as libc::c_int / -col_sep_length
                        }) <= -(1 as libc::c_int) - (columns - 1 as libc::c_int))
                            as libc::c_int
                    }
                } else if (if (if ((if 1 as libc::c_int != 0 {
                ...
                }) != 0 && col_sep_length == -(1 as libc::c_int)
                {
                    ...
                    ((-(32767 as libc::c_int) - 1 as libc::c_int) / col_sep_length
                        < columns - 1 as libc::c_int) as libc::c_int
                }
            } else if col_sep_length == 0 as libc::c_int {
                0 as libc::c_int
                ...
                (32767 as libc::c_int / col_sep_length < columns - 1 as libc::c_int)
                    as libc::c_int
            } != 0
            {
                sep_chars = ((columns - 1 as libc::c_int) as libc::c_uint)
                    .wrapping_mul(col_sep_length as libc::c_uint) as libc::c_short
                    as libc::c_int;
                1 as libc::c_int
            } else {
                sep_chars = ((columns - 1 as libc::c_int) as libc::c_uint)
            ...
            ((32767 as libc::c_int * 2 as libc::c_int + 1 as libc::c_int)
                / col_sep_length < columns - 1 as libc::c_int) as libc::c_int
        } != 0
        {
            sep_chars = ((columns - 1 as libc::c_int) as libc::c_uint)
                .wrapping_mul(col_sep_length as libc::c_uint) as libc::c_ushort
                as libc::c_int;
            1 as libc::c_int
        } else {
            sep_chars = ((columns - 1 as libc::c_int) as libc::c_uint)
        ...
        == ::core::mem::size_of::<libc::c_int>() as libc::c_ulong
    {
        if ((if 1 as libc::c_int != 0 { 0 as libc::c_int } else { sep_chars })
            - 1 as libc::c_int) < 0 as libc::c_int
        {
            if if col_sep_length < 0 as libc::c_int {
                if (columns - 1 as libc::c_int) < 0 as libc::c_int {
                    ...
                    {
                        ((columns - 1 as libc::c_int)
                            < 2147483647 as libc::c_int / col_sep_length) as libc::c_int
                    } else {
                        ((if (if (if ((if 1 as libc::c_int != 0 {
                            0 as libc::c_int
                        } else {
                        ...
                        }) != 0
                        {
                            ...
                            2147483647 as libc::c_int / -col_sep_length
                        }) <= -(1 as libc::c_int) - (columns - 1 as libc::c_int))
                            as libc::c_int
                    }
                } else if (if (if ((if 1 as libc::c_int != 0 {
                ...
                }) != 0 && col_sep_length == -(1 as libc::c_int)
                {
                    ...
                    ((-(2147483647 as libc::c_int) - 1 as libc::c_int) / col_sep_length
                        < columns - 1 as libc::c_int) as libc::c_int
                }
            } else if col_sep_length == 0 as libc::c_int {
                0 as libc::c_int
                ...
                (2147483647 as libc::c_int / col_sep_length < columns - 1 as libc::c_int)
                    as libc::c_int
            } != 0
            {
                sep_chars = ((columns - 1 as libc::c_int) as libc::c_uint)
                    .wrapping_mul(col_sep_length as libc::c_uint) as libc::c_int;
                1 as libc::c_int
            } else {
                sep_chars = ((columns - 1 as libc::c_int) as libc::c_uint)
                    .wrapping_mul(col_sep_length as libc::c_uint) as libc::c_int;
            ...
            if (columns - 1 as libc::c_int) < 0 as libc::c_int {
                if (if 1 as libc::c_int != 0 {
                    ...
                    (if 1 as libc::c_int != 0 {
                        ...
                        .wrapping_add(col_sep_length as libc::c_uint)
                })
                    ...
                    < 0 as libc::c_int as libc::c_uint
                {
                    (((columns - 1 as libc::c_int) as libc::c_uint)
                        < (2147483647 as libc::c_int as libc::c_uint)
                            .wrapping_mul(2 as libc::c_uint)
                            .wrapping_add(1 as libc::c_uint)
                            .wrapping_div(col_sep_length as libc::c_uint)) as libc::c_int
                } else {
                    ((if (if (if ((if 1 as libc::c_int != 0 {
                        0 as libc::c_int
                    } else {
                    ...
                    }) != 0
                    {
                        ...
                        (2147483647 as libc::c_int as libc::c_uint)
                            .wrapping_mul(2 as libc::c_uint)
                            .wrapping_add(1 as libc::c_uint)
                            .wrapping_div(-col_sep_length as libc::c_uint)
                    })
                        <= (-(1 as libc::c_int) - (columns - 1 as libc::c_int))
            ...
            ((2147483647 as libc::c_int as libc::c_uint)
                ...
                .wrapping_add(1 as libc::c_uint)
                .wrapping_div(col_sep_length as libc::c_uint)
                < (columns - 1 as libc::c_int) as libc::c_uint) as libc::c_int
        } != 0
        {
            sep_chars = ((columns - 1 as libc::c_int) as libc::c_uint)
                .wrapping_mul(col_sep_length as libc::c_uint) as libc::c_int;
        ...
        == ::core::mem::size_of::<libc::c_long>() as libc::c_ulong
    {
            ...
            - 1 as libc::c_int) < 0 as libc::c_int
        {
            if if col_sep_length < 0 as libc::c_int {
                if (columns - 1 as libc::c_int) < 0 as libc::c_int {
                    if ((if 1 as libc::c_int != 0 {
                        ...
                        }) + col_sep_length as libc::c_long
                    }) - 1 as libc::c_int as libc::c_long)
                        < 0 as libc::c_int as libc::c_long
                    {
                        (((columns - 1 as libc::c_int) as libc::c_long)
                            < 9223372036854775807 as libc::c_long
                                / col_sep_length as libc::c_long) as libc::c_int
                    } else {
                        ((if (if (if ((if 1 as libc::c_int != 0 {
                            0 as libc::c_int
                        } else {
                ...
                }) != 0 && col_sep_length == -(1 as libc::c_int)
                {
                    ...
                    (((-(9223372036854775807 as libc::c_long) - 1 as libc::c_long)
                        / col_sep_length as libc::c_long)
                        < (columns - 1 as libc::c_int) as libc::c_long) as libc::c_int
                }
            } else if col_sep_length == 0 as libc::c_int {
                0 as libc::c_int
            } else if (columns - 1 as libc::c_int) < 0 as libc::c_int {
                ...
                }) != 0 && columns - 1 as libc::c_int == -(1 as libc::c_int)
                {
                    ...
                    }) - 1 as libc::c_int) < 0 as libc::c_int
                    {
                        ...
                        (-(1 as libc::c_int) as libc::c_long
                            - (-(9223372036854775807 as libc::c_long)
                                - 1 as libc::c_long)
                            < (col_sep_length - 1 as libc::c_int) as libc::c_long)
                            as libc::c_int
                    }
                } else {
                    (((-(9223372036854775807 as libc::c_long) - 1 as libc::c_long)
                ...
                ((9223372036854775807 as libc::c_long / col_sep_length as libc::c_long)
                    < (columns - 1 as libc::c_int) as libc::c_long) as libc::c_int
            } != 0
            {
                sep_chars = ((columns - 1 as libc::c_int) as libc::c_ulong)
                    .wrapping_mul(col_sep_length as libc::c_ulong) as libc::c_long
                    as libc::c_int;
                1 as libc::c_int
            } else {
                sep_chars = ((columns - 1 as libc::c_int) as libc::c_ulong)
            ...
            if (columns - 1 as libc::c_int) < 0 as libc::c_int {
                if (if 1 as libc::c_int != 0 {
                    ...
                    (if 1 as libc::c_int != 0 {
                        ...
                        .wrapping_add(col_sep_length as libc::c_ulong)
                })
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                    < 0 as libc::c_int as libc::c_ulong
                {
                    (((columns - 1 as libc::c_int) as libc::c_ulong)
                        < (9223372036854775807 as libc::c_long as libc::c_ulong)
                            .wrapping_mul(2 as libc::c_ulong)
                            .wrapping_add(1 as libc::c_ulong)
                            .wrapping_div(col_sep_length as libc::c_ulong))
                        as libc::c_int
                } else {
                    ((if (if (if ((if 1 as libc::c_int != 0 {
                        0 as libc::c_int
            ...
            ((9223372036854775807 as libc::c_long as libc::c_ulong)
                ...
                .wrapping_add(1 as libc::c_ulong)
                .wrapping_div(col_sep_length as libc::c_ulong)
                < (columns - 1 as libc::c_int) as libc::c_ulong) as libc::c_int
        } != 0
        {
            sep_chars = ((columns - 1 as libc::c_int) as libc::c_ulong)
                .wrapping_mul(col_sep_length as libc::c_ulong) as libc::c_int;
            1 as libc::c_int
        } else {
            sep_chars = ((columns - 1 as libc::c_int) as libc::c_ulong)
                .wrapping_mul(col_sep_length as libc::c_ulong) as libc::c_int;
    ...
    } else if ((if 1 as libc::c_int != 0 { 0 as libc::c_int } else { sep_chars })
        - 1 as libc::c_int) < 0 as libc::c_int
    {
        if if col_sep_length < 0 as libc::c_int {
            if (columns - 1 as libc::c_int) < 0 as libc::c_int {
                if ((if 1 as libc::c_int != 0 {
                    ...
                    }) + col_sep_length as libc::c_longlong
                }) - 1 as libc::c_int as libc::c_longlong)
                    < 0 as libc::c_int as libc::c_longlong
                {
                    (((columns - 1 as libc::c_int) as libc::c_longlong)
                        < 9223372036854775807 as libc::c_longlong
                            / col_sep_length as libc::c_longlong) as libc::c_int
                } else {
                    ((if (if (if ((if 1 as libc::c_int != 0 {
                        0 as libc::c_int
                    } else {
            ...
            }) != 0 && col_sep_length == -(1 as libc::c_int)
            {
                ...
                (((-(9223372036854775807 as libc::c_longlong) - 1 as libc::c_longlong)
                    / col_sep_length as libc::c_longlong)
                    < (columns - 1 as libc::c_int) as libc::c_longlong) as libc::c_int
            }
        } else if col_sep_length == 0 as libc::c_int {
            0 as libc::c_int
        } else if (columns - 1 as libc::c_int) < 0 as libc::c_int {
            ...
            }) != 0 && columns - 1 as libc::c_int == -(1 as libc::c_int)
            {
                ...
                }) - 1 as libc::c_int) < 0 as libc::c_int
                {
                    ...
                    (-(1 as libc::c_int) as libc::c_longlong
                        - (-(9223372036854775807 as libc::c_longlong)
                            - 1 as libc::c_longlong)
                        < (col_sep_length - 1 as libc::c_int) as libc::c_longlong)
                        as libc::c_int
                }
            } else {
                (((-(9223372036854775807 as libc::c_longlong) - 1 as libc::c_longlong)
        ...
        {
            sep_chars = ((columns - 1 as libc::c_int) as libc::c_ulonglong)
                .wrapping_mul(col_sep_length as libc::c_ulonglong) as libc::c_longlong
                as libc::c_int;
            1 as libc::c_int
        } else {
            sep_chars = ((columns - 1 as libc::c_int) as libc::c_ulonglong)
        ...
        if (columns - 1 as libc::c_int) < 0 as libc::c_int {
            if (if 1 as libc::c_int != 0 {
                ...
                (if 1 as libc::c_int != 0 {
                    ...
                    .wrapping_add(col_sep_length as libc::c_ulonglong)
            })
                .wrapping_sub(1 as libc::c_int as libc::c_ulonglong)
                < 0 as libc::c_int as libc::c_ulonglong
            {
                (((columns - 1 as libc::c_int) as libc::c_ulonglong)
                    < (9223372036854775807 as libc::c_longlong as libc::c_ulonglong)
                        .wrapping_mul(2 as libc::c_ulonglong)
                        .wrapping_add(1 as libc::c_ulonglong)
                        .wrapping_div(col_sep_length as libc::c_ulonglong))
                    as libc::c_int
            } else {
                ((if (if (if ((if 1 as libc::c_int != 0 {
                    0 as libc::c_int
        ...
        }) != 0 && col_sep_length == -(1 as libc::c_int)
        {
            ...
            }) - 1 as libc::c_int) < 0 as libc::c_int
            {
                ...
                ((0 as libc::c_int) < columns - 1 as libc::c_int
                    && (-(1 as libc::c_int) - 0 as libc::c_int)
                        < columns - 1 as libc::c_int - 1 as libc::c_int) as libc::c_int
            }
        } else {
            (0 as libc::c_int / col_sep_length < columns - 1 as libc::c_int)
                as libc::c_int
        ...
        {
            if ((if 1 as libc::c_int != 0 { 0 as libc::c_int } else { col_sep_length })
                - 1 as libc::c_int) < 0 as libc::c_int
            {
                ((0 as libc::c_int) < col_sep_length + 0 as libc::c_int) as libc::c_int
            } else {
                ((-(1 as libc::c_int) - 0 as libc::c_int)
                    < col_sep_length - 1 as libc::c_int) as libc::c_int
            }
        ...
        ((9223372036854775807 as libc::c_longlong as libc::c_ulonglong)
            ...
            .wrapping_add(1 as libc::c_ulonglong)
            .wrapping_div(col_sep_length as libc::c_ulonglong)
            < (columns - 1 as libc::c_int) as libc::c_ulonglong) as libc::c_int
    } != 0
    {
        sep_chars = ((columns - 1 as libc::c_int) as libc::c_ulonglong)
            .wrapping_mul(col_sep_length as libc::c_ulonglong) as libc::c_int;
        1 as libc::c_int
    } else {
        sep_chars = ((columns - 1 as libc::c_int) as libc::c_ulonglong)
            .wrapping_mul(col_sep_length as libc::c_ulonglong) as libc::c_int;
    ...
    let (fresh11, fresh12) = (chars_per_line - chars_used_by_number)
        .overflowing_sub(sep_chars);
    *(&mut useful_chars as *mut libc::c_int) = fresh11;
    if fresh12 {
    ...
    if chars_per_column < 1 as libc::c_int {
        if ::core::mem::size_of::<C2RustUnnamed_6>() as libc::c_ulong != 0 {
            error(
                1 as libc::c_int,
                0 as libc::c_int,
                gettext(b"page width too narrow\0" as *const u8 as *const libc::c_char),
            );
            if 0 as libc::c_int != 0 {} else {
                unreachable!();
            };
...
unsafe extern "C" fn init_store_cols() {
        ...
        == ::core::mem::size_of::<libc::c_schar>() as libc::c_ulong
    {
        if !((0 as libc::c_int) < -(1 as libc::c_int)) {
            if (if columns < 0 as libc::c_int {
                if lines_per_body < 0 as libc::c_int {
                    ...
                    {
                        (lines_per_body < 127 as libc::c_int / columns) as libc::c_int
                    } else {
                        ((if (if (if ((if 1 as libc::c_int != 0 {
                            0 as libc::c_int
                        } else {
                ...
                if columns == 0 as libc::c_int {
                    ...
                    if lines_per_body < 0 as libc::c_int {
                        ...
                        }) != 0 && lines_per_body == -(1 as libc::c_int)
                        {
                            ...
                            {
                                ((0 as libc::c_int)
                                    < columns + (-(127 as libc::c_int) - 1 as libc::c_int))
                                    as libc::c_int
                            } else {
                                (-(1 as libc::c_int)
                                    - (-(127 as libc::c_int) - 1 as libc::c_int)
            ...
            if !((0 as libc::c_int) < -(1 as libc::c_int)) {
                if (if columns < 0 as libc::c_int {
                    if lines_per_body < 0 as libc::c_int {
                        ...
                        {
                            (lines_per_body < 32767 as libc::c_int / columns)
                                as libc::c_int
                        } else {
                            ((if (if (if ((if 1 as libc::c_int != 0 {
                                0 as libc::c_int
                    ...
                    if columns == 0 as libc::c_int {
                        ...
                        if lines_per_body < 0 as libc::c_int {
                            ...
                            }) != 0 && lines_per_body == -(1 as libc::c_int)
                            {
                                ...
                                {
                                    ((0 as libc::c_int)
                                        < columns + (-(32767 as libc::c_int) - 1 as libc::c_int))
                                        as libc::c_int
                                } else {
                                    (-(1 as libc::c_int)
                                        - (-(32767 as libc::c_int) - 1 as libc::c_int)
                        ...
                        }) - 1 as libc::c_int) < 0 as libc::c_int
                        {
                            (lines_per_body
                                < (32767 as libc::c_int * 2 as libc::c_int
                                    + 1 as libc::c_int) / columns) as libc::c_int
                        } else {
                            ((if (if (if ((if 1 as libc::c_int != 0 {
                                0 as libc::c_int
                            } else {
                    ...
                    - 1 as libc::c_int) < 0 as libc::c_int
                {
                    if (if columns < 0 as libc::c_int {
                        if lines_per_body < 0 as libc::c_int {
                            ...
                            {
                                (lines_per_body < 2147483647 as libc::c_int / columns)
                                    as libc::c_int
                            } else {
                                ((if (if (if ((if 1 as libc::c_int != 0 {
                                    0 as libc::c_int
                        ...
                        if lines_per_body < 0 as libc::c_int {
                            if (if 1 as libc::c_int != 0 {
                                ...
                                (if 1 as libc::c_int != 0 {
                                    ...
                                    .wrapping_add(columns as libc::c_uint)
                            })
                                .wrapping_sub(1 as libc::c_int as libc::c_uint)
                                < 0 as libc::c_int as libc::c_uint
                            {
                                ((lines_per_body as libc::c_uint)
                                    < (2147483647 as libc::c_int as libc::c_uint)
                                        .wrapping_mul(2 as libc::c_uint)
                                        .wrapping_add(1 as libc::c_uint)
                                        .wrapping_div(columns as libc::c_uint)) as libc::c_int
                            } else {
                                ((if (if (if ((if 1 as libc::c_int != 0 {
                                    0 as libc::c_int
                                } else {
                            ...
                            if lines_per_body < 0 as libc::c_int {
                                if ((if 1 as libc::c_int != 0 {
                                    ...
                                    (if 1 as libc::c_int != 0 {
                                        ...
                                        9223372036854775807 as libc::c_long
                                    }) + columns as libc::c_long
                                }) - 1 as libc::c_int as libc::c_long)
                                    < 0 as libc::c_int as libc::c_long
                                {
                                    ((lines_per_body as libc::c_long)
                                        < 9223372036854775807 as libc::c_long
                            ...
                            if lines_per_body < 0 as libc::c_int {
                                if (if 1 as libc::c_int != 0 {
                                    ...
                                    (if 1 as libc::c_int != 0 {
                                        ...
                                        .wrapping_add(columns as libc::c_ulong)
                                })
                                    .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                                    < 0 as libc::c_int as libc::c_ulong
                                {
                                    ((lines_per_body as libc::c_ulong)
                                        < (9223372036854775807 as libc::c_long as libc::c_ulong)
                                            .wrapping_mul(2 as libc::c_ulong)
                                            .wrapping_add(1 as libc::c_ulong)
                                            .wrapping_div(columns as libc::c_ulong)) as libc::c_int
                                } else {
                                    ((if (if (if ((if 1 as libc::c_int != 0 {
                                        0 as libc::c_int
                                    } else {
                            ...
                            if lines_per_body < 0 as libc::c_int {
                                if (if 1 as libc::c_int != 0 {
                                    ...
                                    (if 1 as libc::c_int != 0 {
                                        ...
                                        .wrapping_add(columns as libc::c_ulonglong)
                                })
                                    .wrapping_sub(1 as libc::c_int as libc::c_ulonglong)
                                    < 0 as libc::c_int as libc::c_ulonglong
                                {
                                    ((lines_per_body as libc::c_ulonglong)
                                        < (9223372036854775807 as libc::c_longlong
                                            as libc::c_ulonglong)
                                            .wrapping_mul(2 as libc::c_ulonglong)
                                            .wrapping_add(1 as libc::c_ulonglong)
                                            .wrapping_div(columns as libc::c_ulonglong)) as libc::c_int
                                } else {
                                    ((if (if (if ((if 1 as libc::c_int != 0 {
                                        0 as libc::c_int
                                    } else {
        ...
        || {
            ...
            *(&mut total_lines_1 as *mut libc::c_int) = fresh14;
            fresh15 as libc::c_int != 0
        }
        || {
            let (fresh16, fresh17) = chars_per_column.overflowing_add(1 as libc::c_int);
            *(&mut chars_per_column_1 as *mut libc::c_int) = fresh16;
            fresh17 as libc::c_int != 0
        }
        || (if ::core::mem::size_of::<libc::c_int>() as libc::c_ulong
            == ::core::mem::size_of::<libc::c_schar>() as libc::c_ulong
        {
            if !((0 as libc::c_int) < -(1 as libc::c_int)) {
                if (if chars_per_column_1 < 0 as libc::c_int {
                    if total_lines < 0 as libc::c_int {
                        ...
                        {
                            (total_lines < 127 as libc::c_int / chars_per_column_1)
                                as libc::c_int
                        } else {
                            ((if (if (if ((if 1 as libc::c_int != 0 {
                                0 as libc::c_int
                        ...
                        }) != 0 && chars_per_column_1 == -(1 as libc::c_int)
                        {
                            ...
                            {
                                ((0 as libc::c_int)
                                    < total_lines + (-(127 as libc::c_int) - 1 as libc::c_int))
                                    as libc::c_int
                            } else {
                ...
                if !((0 as libc::c_int) < -(1 as libc::c_int)) {
                    if (if chars_per_column_1 < 0 as libc::c_int {
                        if total_lines < 0 as libc::c_int {
                            ...
                            {
                                (total_lines < 32767 as libc::c_int / chars_per_column_1)
                                    as libc::c_int
                            } else {
                                ((if (if (if ((if 1 as libc::c_int != 0 {
                                    0 as libc::c_int
                    ...
                    if (if chars_per_column_1 < 0 as libc::c_int {
                        if total_lines < 0 as libc::c_int {
                            ...
                            }) - 1 as libc::c_int) < 0 as libc::c_int
                            {
                                (total_lines
                                    < (32767 as libc::c_int * 2 as libc::c_int
                                        + 1 as libc::c_int) / chars_per_column_1) as libc::c_int
                            } else {
                                ((if (if (if ((if 1 as libc::c_int != 0 {
                                    0 as libc::c_int
                                } else {
                            ...
                            if total_lines < 0 as libc::c_int {
                                if (if 1 as libc::c_int != 0 {
                                    ...
                                    (if 1 as libc::c_int != 0 {
                                        ...
                                        .wrapping_add(chars_per_column_1 as libc::c_uint)
                                })
                                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
                                    < 0 as libc::c_int as libc::c_uint
                                {
                                    ((total_lines as libc::c_uint)
                                        < (2147483647 as libc::c_int as libc::c_uint)
                                            .wrapping_mul(2 as libc::c_uint)
                                            .wrapping_add(1 as libc::c_uint)
                                ...
                                if total_lines < 0 as libc::c_int {
                                    if (if 1 as libc::c_int != 0 {
                                        ...
                                        (if 1 as libc::c_int != 0 {
                                            ...
                                            .wrapping_add(chars_per_column_1 as libc::c_ulong)
                                    })
                                        .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                                        < 0 as libc::c_int as libc::c_ulong
                                    {
                                        ((total_lines as libc::c_ulong)
                                            < (9223372036854775807 as libc::c_long as libc::c_ulong)
                                                .wrapping_mul(2 as libc::c_ulong)
                                                .wrapping_add(1 as libc::c_ulong)
                            ...
                            if (if chars_per_column_1 < 0 as libc::c_int {
                                if total_lines < 0 as libc::c_int {
                                    if ((if 1 as libc::c_int != 0 {
                                        ...
                                        < 0 as libc::c_int as libc::c_longlong
                                    {
                                        ((total_lines as libc::c_longlong)
                                            < 9223372036854775807 as libc::c_longlong
                                ...
                                if total_lines < 0 as libc::c_int {
                                    if (if 1 as libc::c_int != 0 {
                                        ...
                                        (if 1 as libc::c_int != 0 {
                                            ...
                                            .wrapping_add(chars_per_column_1 as libc::c_ulonglong)
                                    })
                                        .wrapping_sub(1 as libc::c_int as libc::c_ulonglong)
                                        < 0 as libc::c_int as libc::c_ulonglong
                                    {
                                        ((total_lines as libc::c_ulonglong)
                                            < (9223372036854775807 as libc::c_longlong
                                                as libc::c_ulonglong)
                                                .wrapping_mul(2 as libc::c_ulonglong)
                                                .wrapping_add(1 as libc::c_ulonglong)
        ...
        while j != 0 && files_ready_to_read != 0 {
            if (*p).status as libc::c_uint == OPEN as libc::c_int as libc::c_uint {
                    ...
                    || buff_start != buff_current
                {
                    ...
                    *end_vector.offset(fresh18 as isize) = input_position;
                    buff_start = buff_current;
                }
            }
            j -= 1;
...
unsafe extern "C" fn store_char(mut c: libc::c_char) {
    ...
    let fresh19 = buff_current;
    buff_current = buff_current.wrapping_add(1);
    *buff.offset(fresh19 as isize) = c;
}
...
unsafe extern "C" fn print_char(mut c: libc::c_char) {
    if tabify_output {
        if c as libc::c_int == ' ' as i32 {
            ...
            spaces_not_printed;
            return;
        } else if spaces_not_printed > 0 as libc::c_int {
            print_white_space();
        }
        ...
        while separators_not_printed > 0 as libc::c_int {
            loop {
                ...
                if *s as libc::c_int == ' ' as i32 {
                    ...
                    let fresh21 = s;
                    s = s.offset(1);
                    putchar_unlocked(*fresh21 as libc::c_int);
                    output_position += 1;
                    output_position;
                }
            }
...
unsafe extern "C" fn integer_overflow() {
    if ::core::mem::size_of::<C2RustUnnamed_5>() as libc::c_ulong != 0 {
        error(
            1 as libc::c_int,
            0 as libc::c_int,
            gettext(b"integer overflow\0" as *const u8 as *const libc::c_char),
        );
        if 0 as libc::c_int != 0 {} else {
            unreachable!();
        };
...
unsafe extern "C" fn parse_column_count(mut s: *const libc::c_char) {
    getoptnum(
        ...
        1 as libc::c_int,
        &mut columns,
        gettext(b"invalid number of columns\0" as *const u8 as *const libc::c_char),
    );
...
unsafe fn main_0(
    ...
    loop {
            ...
            <= 9 as libc::c_int as libc::c_uint
        {
            ...
            let fresh22 = n_digits;
            n_digits = n_digits.wrapping_add(1);
            *column_count_string.offset(fresh22 as isize) = c as libc::c_char;
            ...
            match c {
                1 => {
                        ...
                        ) as libc::c_int != 0)
                    {
                        ...
                        let ref mut fresh24 = *file_names.offset(fresh23 as isize);
                        *fresh24 = optarg;
                    }
                }
                129 => {
    ...
    while optind < argc {
        let fresh25 = n_files;
        n_files = n_files.wrapping_add(1);
        let ref mut fresh26 = *file_names.offset(fresh25 as isize);
        *fresh26 = *argv.offset(optind as isize);
        optind += 1;
        optind;
    }
    ...
    return if failed_opens as libc::c_int != 0 {
        1 as libc::c_int
    } else {
        0 as libc::c_int
    };
...
unsafe extern "C" fn print_clump(
    ...
    loop {
        ...
        ((*p).char_func).expect("non-null function pointer")(*fresh28);
    };
}
pub fn main() {
