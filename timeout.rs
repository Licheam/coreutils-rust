...
pub const GETOPT_VERSION_CHAR: C2RustUnnamed_13 = -131;
pub const GETOPT_HELP_CHAR: C2RustUnnamed_13 = -130;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct infomap {
...
pub const PRESERVE_STATUS_OPTION: C2RustUnnamed_14 = 129;
pub const FOREGROUND_OPTION: C2RustUnnamed_14 = 128;
#[inline]
...
unsafe extern "C" fn settimeout(mut duration: libc::c_double, mut warn: bool) {
        ...
        == 0 as libc::c_int
    {
        ...
        error(
            0 as libc::c_int,
            *__errno_location(),
            gettext(b"warning: timer_create\0" as *const u8 as *const libc::c_char),
        );
    }
...
unsafe extern "C" fn parse_duration(mut str: *const libc::c_char) -> libc::c_double {
        ...
        || !apply_time_suffix(&mut duration, *ep)
    {
        error(
            0 as libc::c_int,
            0 as libc::c_int,
            gettext(b"invalid time interval %s\0" as *const u8 as *const libc::c_char),
            quote(str),
        );
...
unsafe extern "C" fn unblock_signal(mut sig: libc::c_int) {
        ...
        != 0 as libc::c_int
    {
        error(
            0 as libc::c_int,
            *__errno_location(),
            gettext(b"warning: sigprocmask\0" as *const u8 as *const libc::c_char),
        );
    }
}
...
unsafe extern "C" fn disable_core_dumps() -> bool {
    ...
    error(
        ...
        *__errno_location(),
        gettext(
            b"warning: disabling core dumps failed\0" as *const u8 as *const libc::c_char,
        ),
    );
