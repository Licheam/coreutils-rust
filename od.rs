...
pub const ENDIAN_OPTION: C2RustUnnamed_2 = 129;
pub const TRADITIONAL_OPTION: C2RustUnnamed_2 = 128;
...
unsafe extern "C" fn print_named_ascii(
    ...
    while blank < i {
        ...
        let fresh1 = p;
        p = p.offset(1);
        let mut masked_c: libc::c_int = *fresh1 as libc::c_int & 0x7f as libc::c_int;
...
unsafe extern "C" fn simple_strtoul(
        ...
        <= 9 as libc::c_int as libc::c_uint
    {
        let fresh3 = s;
        s = s.offset(1);
        let mut c: libc::c_int = *fresh3 as libc::c_int - '0' as i32;
        if sum
    ...
    match *s as libc::c_int {
        100 | 111 | 117 | 120 => {
            ...
            'c_10487: {
                ...
                {} else {
                    __assert_fail(
                        b"strlen (tspec->fmt_string) < FMT_BYTES_ALLOCATED\0"
                            as *const u8 as *const libc::c_char,
                        b"src/od.c\0" as *const u8 as *const libc::c_char,
                        746 as libc::c_int as libc::c_uint,
                        (*::core::mem::transmute::<
        ...
        102 => {
            ...
            match size_spec as libc::c_uint {
                ...
                8 => {
                    ...
                    field_width = ((1 as libc::c_int
                        + ((64 as libc::c_int * 1 as libc::c_int * 146 as libc::c_int
                            + 484 as libc::c_int) / 485 as libc::c_int
                            + 1 as libc::c_int)) as libc::c_ulong)
                        .wrapping_add(decimal_point_len)
                        .wrapping_add(1 as libc::c_int as libc::c_ulong)
    ...
    while !in_stream.is_null() {
        ...
        if fstat(fileno(in_stream), &mut file_stats) == 0 as libc::c_int {
            ...
            if usable_size as libc::c_int != 0
                && (if (0 as libc::c_int as libc::c_long) < file_stats.st_blksize
...
unsafe fn main_0(
    ...
    let mut i: size_t = 0;
    let mut l_c_m: libc::c_int = 0;
    let mut desired_width: size_t = 0;
    ...
    let mut pseudo_start: uintmax_t = 0;
            ...
            2 => {
                    ...
                    ) as libc::c_int != 0
                {
                            ...
                            as libc::c_int != 0
                    {
                        ...
                        n_files -= 1;
                        n_files;
                        let ref mut fresh5 = *argv
                            .offset((optind + 1 as libc::c_int) as isize);
                        *fresh5 = *argv.offset(optind as isize);
                        argv = argv.offset(1);
                        argv;
                    }
                }
