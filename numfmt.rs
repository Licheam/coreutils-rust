...
pub const GETOPT_VERSION_CHAR: C2RustUnnamed_2 = -131;
pub const GETOPT_HELP_CHAR: C2RustUnnamed_2 = -130;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct infomap {
...
pub const INVALID_OPTION: C2RustUnnamed_5 = 141;
pub const FORMAT_OPTION: C2RustUnnamed_5 = 140;
pub const HEADER_OPTION: C2RustUnnamed_5 = 139;
pub const DEV_DEBUG_OPTION: C2RustUnnamed_5 = 138;
pub const DEBUG_OPTION: C2RustUnnamed_5 = 137;
pub const FIELD_OPTION: C2RustUnnamed_5 = 136;
pub const PADDING_OPTION: C2RustUnnamed_5 = 135;
pub const GROUPING_OPTION: C2RustUnnamed_5 = 134;
pub const SUFFIX_OPTION: C2RustUnnamed_5 = 133;
pub const ROUND_OPTION: C2RustUnnamed_5 = 132;
pub const TO_UNIT_OPTION: C2RustUnnamed_5 = 131;
pub const TO_OPTION: C2RustUnnamed_5 = 130;
pub const FROM_UNIT_OPTION: C2RustUnnamed_5 = 129;
pub const FROM_OPTION: C2RustUnnamed_5 = 128;
...
pub const DELIMITER_DEFAULT: C2RustUnnamed_6 = 128;
pub type C2RustUnnamed_7 = libc::c_uint;
pub const MAX_UNSCALED_DIGITS: C2RustUnnamed_7 = 18;
pub type C2RustUnnamed_8 = libc::c_uint;
pub const MAX_ACCEPTABLE_DIGITS: C2RustUnnamed_8 = 27;
...
#[inline]
unsafe extern "C" fn valid_suffix(suf: libc::c_char) -> libc::c_int {
    static mut valid_suffixes: *const libc::c_char = b"KMGTPEZY\0" as *const u8
        as *const libc::c_char;
    return (strchr(valid_suffixes, suf as libc::c_int)
...
unsafe extern "C" fn simple_strtod_int(
    ...
    *endptr = input_str as *mut libc::c_char;
    while c_isdigit(**endptr as libc::c_int) {
        ...
        if val != f128::f128::new(0) || digit != 0 {
...
unsafe extern "C" fn simple_strtod_fatal(
    ...
    if inval_style as libc::c_uint != inval_ignore as libc::c_int as libc::c_uint {
        error(conv_exit_code, 0 as libc::c_int, gettext(msgid), quote(input_str));
    }
}
...
unsafe extern "C" fn unit_to_umax(mut n_string: *const libc::c_char) -> uintmax_t {
    ...
    let mut suffixes: *const libc::c_char = b"KMGTPEZY\0" as *const u8
        as *const libc::c_char;
    if n_len != 0
        && !c_isdigit(
            *n_string
        ...
        )
    {
            ...
            && !c_isdigit(*end.offset(-(1 as libc::c_int as isize)) as libc::c_int)
        {
            ...
            *end = '\0' as i32 as libc::c_char;
            suffixes = b"KMGTPEZY0\0" as *const u8 as *const libc::c_char;
        }
        c_string = t_string;
    }
        ...
        || *end as libc::c_int != 0 || n == 0 as libc::c_int as libc::c_ulong
    {
        ...
        if ::core::mem::size_of::<C2RustUnnamed_11>() as libc::c_ulong != 0 {
            error(
                1 as libc::c_int,
                0 as libc::c_int,
                gettext(b"invalid unit size: %s\0" as *const u8 as *const libc::c_char),
                quote(n_string),
            );
            if 0 as libc::c_int != 0 {} else {
                unreachable!();
    ...
    if *fmt.offset(i as isize) as libc::c_int == '\0' as i32 {
        if ::core::mem::size_of::<C2RustUnnamed_15>() as libc::c_ulong != 0 {
            error(
                1 as libc::c_int,
                0 as libc::c_int,
                gettext(b"format %s ends in %%\0" as *const u8 as *const libc::c_char),
                quote(fmt),
            );
            if 0 as libc::c_int != 0 {} else {
                unreachable!();
    ...
    if x > (MAX_ACCEPTABLE_DIGITS as libc::c_int - 1 as libc::c_int) as libc::c_uint {
        if inval_style as libc::c_uint != inval_ignore as libc::c_int as libc::c_uint {
            error(
                ...
                0 as libc::c_int,
                gettext(
                    b"value too large to be printed: '%Lg' (cannot handle values > 999Y)\0"
                        as *const u8 as *const libc::c_char,
                ),
                val,
            );
    ...
    if argc > optind {
        ...
        if ferror_unlocked(stdin) != 0 {
            error(
                0 as libc::c_int,
                *__errno_location(),
                gettext(b"error reading input\0" as *const u8 as *const libc::c_char),
            );
        }
    }
