...
pub const O_PATHSEARCH: C2RustUnnamed_0 = 2097152;
        ...
        if force {
                ...
                != 0 as libc::c_int
            {
                if *__errno_location() != 2 as libc::c_int {
                    ...
                    current_block = 9986002546514143702;
                } else {
                ...
                == 0o40000 as libc::c_int as libc::c_uint
            {
                ...
                } != 0
                {
                    ...
                    if source_status == 0 as libc::c_int
                        ...
                        && (source_stats.st_nlink == 1 as libc::c_int as libc::c_ulong
                            || same_nameat(
                                -(100 as libc::c_int),
                                source,
                                destdir_fd,
...
unsafe fn main_0(
    ...
    if no_target_directory {
            ...
            || link_errno == 20 as libc::c_int || link_errno == 22 as libc::c_int
        {
            ...
            if 0o200000 as libc::c_int == 0 && 0 as libc::c_int <= destdir_fd {
            ...
            if 0 as libc::c_int <= destdir_fd {
                ...
                if ::core::mem::size_of::<C2RustUnnamed_2>() as libc::c_ulong != 0 {
                    error(
                        1 as libc::c_int,
                        err,
                        gettext(b"target %s\0" as *const u8 as *const libc::c_char),
