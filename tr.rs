        ...
        match *s.offset(i as isize) as libc::c_int {
            92 => {
                *((*es).escaped).offset(j as isize) = 1 as libc::c_int != 0;
                ...
                let fresh0 = j;
                j = j.wrapping_add(1);
                *((*es).s).offset(fresh0 as isize) = c as libc::c_char;
            }
            _ => {
                let fresh1 = j;
                j = j.wrapping_add(1);
                *((*es).s).offset(fresh1 as isize) = *s.offset(i as isize);
            }
        }
        i = i.wrapping_add(1);
        i;
...
unsafe extern "C" fn find_bracketed_repeat(
    ...
    'c_9267: {
        if start_idx.wrapping_add(1 as libc::c_int as libc::c_ulong) < (*es).len
        {} else {
            __assert_fail(
                b"start_idx + 1 < es->len\0" as *const u8 as *const libc::c_char,
                b"src/tr.c\0" as *const u8 as *const libc::c_char,
                        ...
                        ) as libc::c_int == ':' as i32
                    {
                        if !append_char_class(result, opnd_str, opnd_str_len) {
                            if star_digits_closebracket(
                                ...
                                current_block = 4335199943124366747;
                            } else {
                                let mut tmp: *mut libc::c_char = make_printable_str(
                                    opnd_str,
                                    opnd_str_len,
        ...
        2 => {
            ...
            'c_10207: {
                if is_char_class_member(
                    ...
                    __assert_fail(
                        b"is_char_class_member (p->u.char_class, s->state)\0"
                            as *const u8 as *const libc::c_char,
                        b"src/tr.c\0" as *const u8 as *const libc::c_char,
                        1079 as libc::c_int as libc::c_uint,
                        (*::core::mem::transmute::<
        ...
        match (*p).type_0 as libc::c_uint {
            ...
            1 => {
                ...
                'c_11364: {
                    ...
                    {} else {
                        __assert_fail(
                            b"p->u.range.last_char >= p->u.range.first_char\0"
                                as *const u8 as *const libc::c_char,
                            b"src/tr.c\0" as *const u8 as *const libc::c_char,
                            1262 as libc::c_int as libc::c_uint,
                            (*::core::mem::transmute::<
...
unsafe extern "C" fn string2_extend(mut s1: *const Spec_list, mut s2: *mut Spec_list) {
    ...
    match (*p).type_0 as libc::c_uint {
        ...
        2 => {
            ...
            current_block_9 = 14314081505593494379;
        }
        4 => {
            current_block_9 = 14314081505593494379;
        }
    ...
    loop {
        ...
        while i < nr {
            if !in_delete_set[to_uchar(*buf.offset(i as isize)) as usize] {
                ...
                *buf.offset(fresh2 as isize) = *buf.offset(i as isize);
            }
            i = i.wrapping_add(1);
            i;
        }
...
unsafe fn main_0(
        ...
        && non_option_args == 2 as libc::c_int
    {
        ...
        if complement {
                        ...
                        == UL_UPPER as libc::c_int as libc::c_uint
                {
                    ...
                    while i_2 < N_CHARS as libc::c_int {
                        if *(*__ctype_b_loc()).offset(i_2 as isize) as libc::c_int
                            ...
                            != 0
                        {
                            xlate[i_2 as usize] = toupper(i_2) as libc::c_char;
                        }
                        i_2 += 1;
                        i_2;
                    }
                        ...
                        == UL_LOWER as libc::c_int as libc::c_uint
                {
                    ...
                    while i_3 < N_CHARS as libc::c_int {
                        if *(*__ctype_b_loc()).offset(i_3 as isize) as libc::c_int
                            ...
                            != 0
                        {
                            xlate[i_3 as usize] = tolower(i_3) as libc::c_char;
                        }
                        i_3 += 1;
                        i_3;
                    }
            ...
            'c_13439: {
                if c1 == -(1 as libc::c_int) || truncate_set1 as libc::c_int != 0
                {} else {
                    __assert_fail(
                        b"c1 == -1 || truncate_set1\0" as *const u8
                            as *const libc::c_char,
                        b"src/tr.c\0" as *const u8 as *const libc::c_char,
                        1890 as libc::c_int as libc::c_uint,
                        (*::core::mem::transmute::<
