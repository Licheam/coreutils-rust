...
pub unsafe extern "C" fn usage(mut status: libc::c_int) -> ! {
    if status != 0 as libc::c_int {
        ...
        emit_ancillary_info(b"hostid\0" as *const u8 as *const libc::c_char);
    }
    exit(status);
}
#[inline]
...
unsafe fn main_0(
    ...
    parse_gnu_standard_options_only(
        argc,
        argv,
        b"hostid\0" as *const u8 as *const libc::c_char,
        b"GNU coreutils\0" as *const u8 as *const libc::c_char,
        Version,
        1 as libc::c_int != 0,
        ::core::mem::transmute::<
    ...
    id = gethostid() as libc::c_uint;
    id &= 0xffffffff as libc::c_uint;
