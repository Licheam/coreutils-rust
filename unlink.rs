...
pub unsafe extern "C" fn usage(mut status: libc::c_int) -> ! {
    if status != 0 as libc::c_int {
        ...
        fputs_unlocked(
            gettext(
                b"Call the unlink function to remove the specified FILE.\n\n\0"
        ...
        emit_ancillary_info(b"unlink\0" as *const u8 as *const libc::c_char);
    }
    exit(status);
}
#[inline]
...
unsafe fn main_0(
    ...
    if unlink(*argv.offset(optind as isize)) != 0 as libc::c_int {
        if ::core::mem::size_of::<C2RustUnnamed>() as libc::c_ulong != 0 {
            error(
                1 as libc::c_int,
                *__errno_location(),
                gettext(b"cannot unlink %s\0" as *const u8 as *const libc::c_char),
                quotearg_style(
