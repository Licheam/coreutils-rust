    ...
    if *__errno_location() != 0 {
        ...
        if s == end {
            error(
                ...
                0 as libc::c_int,
                gettext(
                    b"%s: expected a numeric value\0" as *const u8 as *const libc::c_char,
                ),
                quote(s),
            );
        } else {
...
unsafe extern "C" fn vstrtoimax(mut s: *const libc::c_char) -> intmax_t {
        ...
        && *s.offset(1 as libc::c_int as isize) as libc::c_int != 0
    {
        ...
        if *s as libc::c_int != 0 as libc::c_int && !posixly_correct {
            error(0 as libc::c_int, 0 as libc::c_int, gettext(cfcc_msg), s);
        }
    } else {
...
unsafe extern "C" fn print_esc(
            ...
            .is_null()
    {
        ...
        if uni_value <= 0x9f as libc::c_int as libc::c_uint
            && uni_value != 0x24 as libc::c_int as libc::c_uint
            && uni_value != 0x40 as libc::c_int as libc::c_uint
            && uni_value != 0x60 as libc::c_int as libc::c_uint
            || uni_value >= 0xd800 as libc::c_int as libc::c_uint
                    ...
                    if *f as libc::c_int == '.' as i32 {
                        ...
                        if *f as libc::c_int == '*' as i32 {
                            ...
                            if argc > 0 as libc::c_int {
                                ...
                                {
                                    if ::core::mem::size_of::<C2RustUnnamed_4>()
                                        as libc::c_ulong != 0
                                    {
                                        error(
                                            1 as libc::c_int,
