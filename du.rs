...
pub const INODES_OPTION: C2RustUnnamed_2 = 135;
pub const TIME_STYLE_OPTION: C2RustUnnamed_2 = 134;
pub const TIME_OPTION: C2RustUnnamed_2 = 133;
pub const FTS_DEBUG: C2RustUnnamed_2 = 132;
pub const HUMAN_SI_OPTION: C2RustUnnamed_2 = 131;
pub const FILES0_FROM_OPTION: C2RustUnnamed_2 = 130;
pub const EXCLUDE_OPTION: C2RustUnnamed_2 = 129;
pub const APPARENT_SIZE_OPTION: C2RustUnnamed_2 = 128;
...
unsafe extern "C" fn process_file(mut fts: *mut FTS, mut ent: *mut FTSENT) -> bool {
    ...
    if info == 4 as libc::c_int {
        error(
            0 as libc::c_int,
            (*ent).fts_errno,
            gettext(b"cannot read directory %s\0" as *const u8 as *const libc::c_char),
            ...
            || !opt_count_all
                && (hash_all as libc::c_int != 0
                    || !((*sb).st_mode & 0o170000 as libc::c_int as libc::c_uint
                        ...
                        && (1 as libc::c_int as libc::c_ulong) < (*sb).st_nlink)
        ...
        match c {
            ...
            116 => {
                ...
                e = xstrtoimax(
                    ...
                    0 as libc::c_int,
                    &mut opt_threshold,
                    b"kKmMGTPEZY0\0" as *const u8 as *const libc::c_char,
                );
