...
pub const GETOPT_VERSION_CHAR: C2RustUnnamed_1 = -131;
pub const GETOPT_HELP_CHAR: C2RustUnnamed_1 = -130;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct infomap {
            ...
            92 => {
                ...
                match *s.offset(i as isize) as libc::c_int {
                    ...
                    114 => {
                        let fresh1 = dst;
                        dst = dst.offset(1);
                        *fresh1 = '\r' as i32 as libc::c_char;
                    }
                    92 => {
                        let fresh2 = dst;
                        dst = dst.offset(1);
...
unsafe extern "C" fn hex_digits(mut s: *const libc::c_uchar) -> bool {
...
unsafe extern "C" fn bsd_split_3(
    mut s: *mut libc::c_char,
    mut s_len: size_t,
    mut hex_digest: *mut *mut libc::c_uchar,
    ...
    i = s_len.wrapping_sub(1 as libc::c_int as libc::c_ulong);
    ...
    *file_name = s;
    ...
    let fresh4 = i;
    i = i.wrapping_add(1);
    *s.offset(fresh4 as isize) = '\0' as i32 as libc::c_char;
    ...
    *hex_digest = &mut *s.offset(i as isize) as *mut libc::c_char as *mut libc::c_uchar;
...
unsafe extern "C" fn split_3(
    ...
    *hex_digest = &mut *s.offset(i as isize) as *mut libc::c_char as *mut libc::c_uchar;
    i = (i as libc::c_ulong).wrapping_add(digest_hex_bytes) as size_t as size_t;
    if !(*s.offset(i as isize) as libc::c_int == ' ' as i32
        || *s.offset(i as isize) as libc::c_int == '\t' as i32)
    {
        return 0 as libc::c_int != 0;
    ...
    *s.offset(fresh5 as isize) = '\0' as i32 as libc::c_char;
            ...
            && *s.offset(i as isize) as libc::c_int != '*' as i32
    {
        ...
        let fresh6 = i;
        i = i.wrapping_add(1);
        *binary = (*s.offset(fresh6 as isize) as libc::c_int == '*' as i32)
            as libc::c_int;
    }
...
unsafe extern "C" fn digest_check(mut checkfile_name: *const libc::c_char) -> bool {
    ...
    let mut n_improperly_formatted_lines: uintmax_t = 0 as libc::c_int as uintmax_t;
    ...
    loop {
        ...
        let mut hex_digest: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
            ...
            if !(line_length == 0 as libc::c_int as libc::c_long) {
                *line.offset(line_length as isize) = '\0' as i32 as libc::c_char;
                            ...
                            == 0 as libc::c_int))
                {
                    ...
                    n_improperly_formatted_lines = n_improperly_formatted_lines
                        .wrapping_add(1);
                    ...
                    if !ok {
                        ...
                        if !status_only {
                            ...
                            printf(
                                b": %s\n\0" as *const u8 as *const libc::c_char,
                                gettext(
                                    b"FAILED open or read\0" as *const u8 as *const libc::c_char,
                                ),
                            );
                        }
                        ...
                        && missing as libc::c_int != 0)
                    {
                        ...
                        if !status_only {
                            ...
                            if cnt != digest_bin_bytes {
                                printf(
                                    b": %s\n\0" as *const u8 as *const libc::c_char,
                                    gettext(b"FAILED\0" as *const u8 as *const libc::c_char),
                                );
                            } else if !quiet {
                                printf(
                                    b": %s\n\0" as *const u8 as *const libc::c_char,
                                    gettext(b"OK\0" as *const u8 as *const libc::c_char),
                                );
                            }
                        }
                    }
    ...
    return properly_formatted_lines as libc::c_int != 0
        ...
        && (!strict
            || n_improperly_formatted_lines == 0 as libc::c_int as libc::c_ulong);
}
unsafe fn main_0(
    mut argc: libc::c_int,
    ...
    if optind == argc {
        let fresh7 = operand_lim;
        operand_lim = operand_lim.offset(1);
        *fresh7 = bad_cast(b"-\0" as *const u8 as *const libc::c_char);
    }
