...
unsafe extern "C" fn is_cjk_encoding(mut encoding: *const libc::c_char) -> libc::c_int {
    if 0 as libc::c_int != 0
        || strcmp(encoding, b"EUC-JP\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(encoding, b"GB2312\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(encoding, b"GBK\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(encoding, b"EUC-TW\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(encoding, b"BIG5\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(encoding, b"EUC-KR\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(encoding, b"CP949\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(encoding, b"JOHAB\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
    {
        return 1 as libc::c_int;
    }
