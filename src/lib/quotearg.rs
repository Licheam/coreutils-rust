    ...
    '_process_input: loop {
        ...
        match quoting_style as libc::c_uint {
            6 => {
                ...
                current_block_47 = 18313606856409834625;
            }
            5 => {
                current_block_47 = 18313606856409834625;
            }
            ...
            3 => {
                backslash_escapes = 1 as libc::c_int != 0;
                current_block_47 = 7154437211896300733;
            }
            1 => {
                current_block_47 = 7154437211896300733;
            }
            4 => {
                current_block_47 = 990147482808137184;
            }
            2 => {
                current_block_47 = 1195315992794846257;
            }
            0 => {
                elide_outer_quotes = 0 as libc::c_int != 0;
                current_block_47 = 14775119014532381840;
        ...
        } == 0
        {
            ...
            {
                if elide_outer_quotes {
                    current_block = 6359314931905504138;
            ...
            match c as libc::c_int {
                ...
                63 => {
                    match quoting_style as libc::c_uint {
                        2 => {
                            current_block = 8205257777967751236;
                            match current_block {
                                8205257777967751236 => {
                                    if elide_outer_quotes {
                                        current_block = 6359314931905504138;
                        ...
                        5 => {
                            current_block = 8124030124241512660;
                            match current_block {
                                8205257777967751236 => {
                                    if elide_outer_quotes {
                                        current_block = 6359314931905504138;
                ...
                7 => {
                    ...
                    current_block = 17620735847256451497;
                }
                8 => {
                ...
                10 => {
                    ...
                    current_block = 2368726799945326913;
                }
                13 => {
                ...
                92 => {
                        ...
                        == shell_always_quoting_style as libc::c_int as libc::c_uint
                    {
                        ...
                        current_block = 6534202321968832468;
                ...
                123 | 125 => {
                    ...
                    } == 0
                    {
                        ...
                        current_block = 15189604093370545603;
                    }
                }
                35 | 126 => {
                    current_block = 15189604093370545603;
                ...
                32 => {
                    current_block = 7799146501415385693;
                }
                33 | 34 | 36 | 38 | 40 | 41 | 42 | 59 | 60 | 61 | 62 | 91 | 94 | 96
                | 124 => {
