...
pub unsafe extern "C" fn readtokens0(mut in_0: *mut FILE, mut t: *mut Tokens) -> bool {
    ...
    let ref mut fresh2 = *(__p1 as *mut *const libc::c_void);
    *fresh2 = 0 as *const libc::c_void;
    (*__o1)
