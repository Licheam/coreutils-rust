            ...
            match format_char {
                37 => {
                    if modifier != 0 as libc::c_int {
                        current_block = 15779347530645738384;
                    } else {
                ...
                97 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 6673445768392692601;
                    }
                }
                65 => {
                    if modifier != 0 as libc::c_int {
                ...
                67 => {
                    if modifier == 'E' as i32 {
                        ...
                        current_block = 16410177711071879398;
                    }
                }
                120 => {
                    if modifier == 'O' as i32 {
                ...
                68 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 13568222477101224033;
                    }
                }
                100 => {
                    if modifier == 'E' as i32 {
                        ...
                        current_block = 17302247208681363999;
                    }
                }
                101 => {
                    if modifier == 'E' as i32 {
                        ...
                        digits = 2 as libc::c_int;
                        number_value = (*tp).tm_mday;
                        current_block = 9955575239349833292;
                    }
                }
                70 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 301262923791004910;
                    }
                }
                72 => {
                    if modifier == 'E' as i32 {
                ...
                106 => {
                    if modifier == 'E' as i32 {
                        ...
                        u_number_value = ((*tp).tm_yday as libc::c_uint)
                            .wrapping_add(1 as libc::c_uint);
                        current_block = 14742602869322824221;
                    }
                }
                77 => {
                    if modifier == 'E' as i32 {
                ...
                80 => {
                    ...
                    current_block = 18332400853987273087;
                }
                112 => {
                    current_block = 18332400853987273087;
                }
                ...
                115 => {
                    ...
                    current_block = 4890668108774598813;
                }
                88 => {
                    if modifier == 'O' as i32 {
                        current_block = 15779347530645738384;
                ...
                58 => {
                    ...
                    if *f.offset(colons as isize) as libc::c_int != 'z' as i32 {
                        ...
                        current_block = 2380170218874449148;
                    }
                }
                122 => {
                ...
                _ => {
                    match current_block {
                        16410177711071879398 => {
                            ...
                            current_block = 15245900778146034427;
                        }
                        2380170218874449148 => {
                            if (*tp).tm_isdst < 0 as libc::c_int {
                                ...
                                match colons {
                                    0 => {
                                        ...
                                        match current_block {
                                            14795592282877320006 => {
                                                ...
                                                u_number_value = (hour_diff * 100 as libc::c_int + min_diff)
                                                    as libc::c_uint;
                                                current_block = 11134863277259671538;
                                            }
                                        ...
                                        current_block = 15542076304871114081;
                                    }
                                    1 => {
                                        current_block = 6225579869370739012;
                                        match current_block {
                                    ...
                                    3 => {
                                        current_block = 11729455350843475820;
                                        match current_block {
                                            14795592282877320006 => {
                                                digits = 5 as libc::c_int;
                                                tz_colon_mask = 0 as libc::c_int;
