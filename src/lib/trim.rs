...
pub unsafe extern "C" fn trim2(
    ...
    if __ctype_get_mb_cur_max() > 1 as libc::c_int as libc::c_ulong {
        ...
        if how != 1 as libc::c_int {
                        ...
                        && iswspace(i.cur.wc as wint_t) != 0))
                {
                    if state == 0 as libc::c_int as libc::c_uint
                        && !(i.cur.wc_valid as libc::c_int != 0
                            && iswspace(i.cur.wc as wint_t) != 0)
                    {
                        state = 1 as libc::c_int as libc::c_uint;
                    } else if !(state == 1 as libc::c_int as libc::c_uint
                        && !(i.cur.wc_valid as libc::c_int != 0
                            && iswspace(i.cur.wc as wint_t) != 0))
                    {
                        if state == 1 as libc::c_int as libc::c_uint
                            && (i.cur.wc_valid as libc::c_int != 0
                                && iswspace(i.cur.wc as wint_t) != 0)
                        {
                            state = 2 as libc::c_int as libc::c_uint;
                            r = i.cur.ptr as *mut libc::c_char;
                        } else if !(state == 2 as libc::c_int as libc::c_uint
                            && (i.cur.wc_valid as libc::c_int != 0
                                && iswspace(i.cur.wc as wint_t) != 0))
                        {
                            state = 1 as libc::c_int as libc::c_uint;
            ...
            if state == 2 as libc::c_int as libc::c_uint {
...
unsafe extern "C" fn mbiter_multi_next(mut iter: *mut mbiter_multi) {
    ...
    if (*iter).in_shift {
        current_block = 17750062988838161597;
