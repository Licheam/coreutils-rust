...
unsafe extern "C" fn fwrite_uppcase(
    ...
    loop {
        ...
        fputc(toupper(*src as libc::c_uchar as libc::c_int), fp);
        src = src.offset(1);
        src;
    };
}
unsafe extern "C" fn fwrite_lowcase(
    ...
    loop {
        ...
        fputc(tolower(*src as libc::c_uchar as libc::c_int), fp);
        src = src.offset(1);
        src;
    };
}
            ...
            match format_char {
                37 => {
                    if modifier != 0 as libc::c_int {
                        current_block = 1279122998052564840;
                    } else {
                ...
                97 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 7357333231642200634;
                    }
                }
                65 => {
                    if modifier != 0 as libc::c_int {
                ...
                67 => {
                    if modifier == 'E' as i32 {
                        ...
                        current_block = 11961694765042255793;
                    }
                }
                120 => {
                    if modifier == 'O' as i32 {
                ...
                68 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 3597564172888977989;
                    }
                }
                100 => {
                    if modifier == 'E' as i32 {
                        ...
                        current_block = 18203198114181771425;
                    }
                }
                101 => {
                    if modifier == 'E' as i32 {
                        ...
                        digits = 2 as libc::c_int;
                        number_value = (*tp).tm_mday;
                        current_block = 12891918359488224820;
                    }
                }
                70 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 2000601731888620484;
                    }
                }
                72 => {
                    if modifier == 'E' as i32 {
                ...
                106 => {
                    if modifier == 'E' as i32 {
                        ...
                        u_number_value = ((*tp).tm_yday as libc::c_uint)
                            .wrapping_add(1 as libc::c_uint);
                        current_block = 6215517699732444003;
                    }
                }
                77 => {
                    if modifier == 'E' as i32 {
                ...
                80 => {
                    ...
                    current_block = 3939213700508143372;
                }
                112 => {
                    current_block = 3939213700508143372;
                }
                ...
                115 => {
                    ...
                    current_block = 17430022569426872861;
                }
                88 => {
                    if modifier == 'O' as i32 {
                        current_block = 1279122998052564840;
                ...
                58 => {
                    ...
                    if *f.offset(colons as isize) as libc::c_int != 'z' as i32 {
                        ...
                        current_block = 16350986490659780064;
                    }
                }
                122 => {
                ...
                _ => {
                    match current_block {
                        11961694765042255793 => {
                            ...
                            current_block = 8527192881833854544;
                        }
                        16350986490659780064 => {
                            if (*tp).tm_isdst < 0 as libc::c_int {
                                ...
                                match colons {
                                    0 => {
                                        ...
                                        match current_block {
                                            11256224404817644654 => {
                                                ...
                                                u_number_value = (hour_diff * 100 as libc::c_int + min_diff)
                                                    as libc::c_uint;
                                                current_block = 15352076293618566532;
                                            }
                                            8713146328107349101 => {
                                        ...
                                        current_block = 11483239742279143214;
                                    }
                                    1 => {
                                        current_block = 9136364834649731412;
                                        match current_block {
                                    ...
                                    3 => {
                                        current_block = 8713146328107349101;
                                        match current_block {
                                            11256224404817644654 => {
                                                digits = 5 as libc::c_int;
                                                tz_colon_mask = 0 as libc::c_int;
