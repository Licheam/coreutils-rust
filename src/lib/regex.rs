...
pub unsafe extern "C" fn rpl_regerror(
    ...
    msg = gettext(
        __re_error_msgid.as_ptr().offset(__re_error_msgid_idx[errcode as usize] as isize),
    );
...
unsafe extern "C" fn bitset_set(mut set: *mut bitset_word_t, mut i: Idx) {
    let ref mut fresh2 = *set.offset((i / 64 as libc::c_int as libc::c_long) as isize);
    *fresh2
...
unsafe extern "C" fn bitset_mask(
    ...
    while bitset_i
        < (127 as libc::c_int * 2 as libc::c_int + 1 as libc::c_int + 1 as libc::c_int
            + 64 as libc::c_int - 1 as libc::c_int) / 64 as libc::c_int
    {
        let ref mut fresh3 = *dest.offset(bitset_i as isize);
        *fresh3 &= *src.offset(bitset_i as isize);
        bitset_i += 1;
        bitset_i;
    }
}
...
unsafe extern "C" fn create_ci_newstate(
    ...
    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int as libc::c_long
        != 0
    {
        free(newstate as *mut libc::c_void);
        return 0 as *mut re_dfastate_t;
    }
                ...
                != 0
            {
                ...
                if wcu_0 != wc {
                    ...
                    if (mbclen == mbcdlen) as libc::c_int as libc::c_long != 0 {
                        ...
                        src_idx = byte_idx;
                        current_block_88 = 17052557517587557487;
                        break;
                    }
                } else {
                    memcpy(
...
unsafe extern "C" fn build_upper_buffer(mut pstr: *mut re_string_t) {
    ...
    while char_idx < end_idx {
        ...
        *((*pstr).mbs).offset(char_idx as isize) = toupper(ch) as libc::c_uchar;
        char_idx += 1;
        char_idx;
    }
...
unsafe extern "C" fn re_string_destruct(mut pstr: *mut re_string_t) {
    free((*pstr).wcs as *mut libc::c_void);
    free((*pstr).offsets as *mut libc::c_void);
    if (*pstr).mbs_allocated != 0 {
        free((*pstr).mbs as *mut libc::c_void);
    }
}
...
unsafe extern "C" fn re_dfa_add_node(
    ...
    if ((*dfa).nodes_len >= (*dfa).nodes_alloc) as libc::c_int as libc::c_long != 0 {
        ...
        {
            free(new_nexts as *mut libc::c_void);
            free(new_indices as *mut libc::c_void);
            free(new_edests as *mut libc::c_void);
            free(new_eclosures as *mut libc::c_void);
            return -(1 as libc::c_int) as Idx;
        }
        (*dfa).nexts = new_nexts;
...
unsafe extern "C" fn free_state(mut state: *mut re_dfastate_t) {
    free((*state).non_eps_nodes.elems as *mut libc::c_void);
    free((*state).inveclosure.elems as *mut libc::c_void);
    if (*state).entrance_nodes != &mut (*state).nodes as *mut re_node_set {
        free((*(*state).entrance_nodes).elems as *mut libc::c_void);
        free((*state).entrance_nodes as *mut libc::c_void);
    }
    free((*state).nodes.elems as *mut libc::c_void);
    free((*state).word_trtable as *mut libc::c_void);
    free((*state).trtable as *mut libc::c_void);
...
unsafe extern "C" fn free_charset(mut cset: *mut re_charset_t) {
    free((*cset).mbchars as *mut libc::c_void);
    free((*cset).range_starts as *mut libc::c_void);
    free((*cset).range_ends as *mut libc::c_void);
    free((*cset).char_classes as *mut libc::c_void);
...
unsafe extern "C" fn free_workarea_compile(mut preg: *mut regex_t) {
    ...
    free((*dfa).org_indices as *mut libc::c_void);
...
unsafe extern "C" fn create_initial_state(mut dfa: *mut re_dfa_t) -> reg_errcode_t {
    ...
    free(init_nodes.elems as *mut libc::c_void);
    return _REG_NOERROR;
}
...
unsafe extern "C" fn analyze(mut preg: *mut regex_t) -> reg_errcode_t {
    ...
    if !((*dfa).subexp_map).is_null() {
        ...
        if i as libc::c_ulong == (*preg).re_nsub {
            free((*dfa).subexp_map as *mut libc::c_void);
    ...
    loop {
            ...
            != 0 as libc::c_int as libc::c_long)
        {
                ...
                == 0 as libc::c_int as libc::c_long
            {
                ...
                free(eclosure_elem.elems as *mut libc::c_void);
            }
        }
        node_idx += 1;
        node_idx;
...
unsafe extern "C" fn parse_expression(
    ...
    match (*token).type_0() as libc::c_int {
        ...
        23 => {
            ...
            current_block_103 = 12892275591619738908;
        }
        11 | 18 | 19 => {
            current_block_103 = 12892275591619738908;
        }
        9 => {
            current_block_103 = 16248428628490818279;
        }
        24 => {
            current_block_103 = 16797176143392079476;
        }
        12 => {
    ...
    if (start > 0 as libc::c_int as libc::c_long) as libc::c_int as libc::c_long != 0 {
        ...
        loop {
            ...
            if (elem.is_null() || tree.is_null()) as libc::c_int as libc::c_long != 0 {
                current_block = 10821926907274378967;
                break;
            }
            i += 1;
            i;
...
unsafe extern "C" fn parse_bracket_exp(
    ...
    if (sbcset.is_null() || mbcset.is_null()) as libc::c_int as libc::c_long != 0 {
        free(sbcset as *mut libc::c_void);
        free(mbcset as *mut libc::c_void);
        *err = _REG_ESPACE;
        return 0 as *mut bin_tree_t;
    }
        ...
        as libc::c_long != 0
    {
        *err = _REG_BADPAT;
        ...
        if (*token).type_0() as libc::c_int == OP_NON_MATCH_LIST as libc::c_int {
            ...
            {
                *err = _REG_BADPAT;
                current_block = 4255304710208115759;
            } else {
                                ...
                                1 => {
                                        ...
                                        as libc::c_long != 0
                                    {
                                        ...
                                        if (new_mbchars == 0 as *mut libc::c_void as *mut wchar_t)
                                            as libc::c_int as libc::c_long != 0
                                        {
                                            current_block = 4003850857271807231;
                                            break;
                                        }
...
unsafe extern "C" fn free_token(mut node: *mut re_token_t) {
        ...
        && (*node).duplicated() as libc::c_int == 0 as libc::c_int
    {
        ...
        && (*node).duplicated() as libc::c_int == 0 as libc::c_int
    {
        free((*node).opr.sbcset as *mut libc::c_void);
    }
}
...
unsafe extern "C" fn re_set_fastmap(
    ...
    *fastmap.offset(ch as isize) = 1 as libc::c_int as libc::c_char;
    if icase {
        *fastmap.offset(tolower(ch) as isize) = 1 as libc::c_int as libc::c_char;
    }
}
...
unsafe extern "C" fn free_dfa_content(mut dfa: *mut re_dfa_t) {
    ...
    free((*dfa).nexts as *mut libc::c_void);
    i = 0 as libc::c_int as Idx;
    while (i as libc::c_ulong) < (*dfa).nodes_len {
        if !((*dfa).eclosures).is_null() {
            free((*((*dfa).eclosures).offset(i as isize)).elems as *mut libc::c_void);
        }
        if !((*dfa).inveclosures).is_null() {
            free((*((*dfa).inveclosures).offset(i as isize)).elems as *mut libc::c_void);
        }
        if !((*dfa).edests).is_null() {
            free((*((*dfa).edests).offset(i as isize)).elems as *mut libc::c_void);
        }
        i += 1;
        i;
    }
    free((*dfa).edests as *mut libc::c_void);
    free((*dfa).eclosures as *mut libc::c_void);
    free((*dfa).inveclosures as *mut libc::c_void);
    free((*dfa).nodes as *mut libc::c_void);
    if !((*dfa).state_table).is_null() {
        ...
        while i as libc::c_ulong <= (*dfa).state_hash_mask {
            ...
            free((*entry).array as *mut libc::c_void);
            i += 1;
            i;
        }
    }
    free((*dfa).state_table as *mut libc::c_void);
    if (*dfa).sb_char != utf8_sb_map.as_ptr() as re_bitset_ptr_t {
        free((*dfa).sb_char as *mut libc::c_void);
    }
    free((*dfa).subexp_map as *mut libc::c_void);
    free(dfa as *mut libc::c_void);
}
unsafe extern "C" fn init_word_char(mut dfa: *mut re_dfa_t) {
        ...
        as libc::c_long != 0
    {
        ...
        if 64 as libc::c_int == 64 as libc::c_int {
            ...
            current_block = 18267866385261942885;
        }
        match current_block {
            18267866385261942885 => {}
            _ => {
        ...
        match c2_0 as libc::c_int {
            ...
            58 => {
                        ...
                        << 1 as libc::c_int != 0
                {
                    ...
                    current_block_28 = 365050735104495308;
                }
            }
            _ => {
                current_block_28 = 365050735104495308;
    ...
    if !mbcset.is_null() {
        if (*range_alloc == (*mbcset).nranges) as libc::c_int as libc::c_long != 0 {
            ...
            if (new_array_start.is_null() || new_array_end.is_null()) as libc::c_int
                as libc::c_long != 0
            {
                free(new_array_start as *mut libc::c_void);
                free(new_array_end as *mut libc::c_void);
                return _REG_ESPACE;
            }
        ...
        *((*mbcset).range_starts)
        ...
        let fresh47 = (*mbcset).nranges;
        (*mbcset).nranges = (*mbcset).nranges + 1;
        *((*mbcset).range_ends).offset(fresh47 as isize) = end_wc as wchar_t;
    }
    wc = 0 as libc::c_int;
    while wc
        < 127 as libc::c_int * 2 as libc::c_int + 1 as libc::c_int + 1 as libc::c_int
...
unsafe extern "C" fn regmatch_list_free__array__(mut list: *mut regmatch_list) {
    if (*list).u.dynarray_header.array != ((*list).scratch).as_mut_ptr() {
        free((*list).u.dynarray_header.array as *mut libc::c_void);
    }
}
...
unsafe extern "C" fn check_matching(
    ...
    if !((*mctx).state_log).is_null() {
        let ref mut fresh48 = *((*mctx).state_log).offset(cur_str_idx as isize);
        *fresh48 = cur_state;
        if (*dfa).nbackref != 0 {
...
unsafe extern "C" fn match_ctx_add_subtop(
    ...
    let ref mut fresh49 = *((*mctx).sub_tops).offset((*mctx).nsub_tops as isize);
    *fresh49 = calloc(
        1 as libc::c_int as libc::c_ulong,
    ...
    let fresh50 = (*mctx).nsub_tops;
    (*mctx).nsub_tops = (*mctx).nsub_tops + 1;
    (**((*mctx).sub_tops).offset(fresh50 as isize)).str_idx = str_idx;
    return _REG_NOERROR;
}
unsafe extern "C" fn match_ctx_add_entry(
    ...
    if (*mctx).nbkref_ents >= (*mctx).abkref_ents {
        ...
        if (new_entry == 0 as *mut libc::c_void as *mut re_backref_cache_entry)
            as libc::c_int as libc::c_long != 0
        {
            free((*mctx).bkref_ents as *mut libc::c_void);
            return _REG_ESPACE;
        }
    ...
    let fresh51 = (*mctx).nbkref_ents;
    (*mctx).nbkref_ents = (*mctx).nbkref_ents + 1;
    (*((*mctx).bkref_ents).offset(fresh51 as isize))
...
unsafe extern "C" fn match_ctx_add_sublast(
    ...
    if (new_entry != 0 as *mut libc::c_void as *mut re_sub_match_last_t) as libc::c_int
        as libc::c_long != 0
    {
        let ref mut fresh52 = *((*subtop).lasts).offset((*subtop).nlasts as isize);
        *fresh52 = new_entry;
        (*new_entry).node = node;
...
unsafe extern "C" fn re_search_2_stub(
    ...
    if (length1 < 0 as libc::c_int as libc::c_long
        ...
        || {
            let (fresh53, fresh54) = length1.overflowing_add(length2);
            *(&mut len as *mut Idx) = fresh53;
            fresh54 as libc::c_int != 0
        }) as libc::c_int as libc::c_long != 0
    {
...
unsafe extern "C" fn update_cur_sifted_state(
    ...
    if (*dest_nodes).nelem == 0 as libc::c_int as libc::c_long {
        let ref mut fresh55 = *((*sctx).sifted_states).offset(str_idx as isize);
        *fresh55 = 0 as *mut re_dfastate_t;
    } else {
        ...
        *fresh56 = re_acquire_state(&mut err, dfa, dest_nodes);
        if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
            as libc::c_long != 0
        {
            return err;
...
unsafe extern "C" fn re_search_stub(
        ...
        as libc::c_long != 0
    {
        ...
        free(pmatch as *mut libc::c_void);
    }
    if 1 as libc::c_int != 0 {
        pthread_mutex_unlock(&mut (*dfa).lock);
    } else {};
...
unsafe extern "C" fn match_ctx_free(mut mctx: *mut re_match_context_t) {
    ...
    free((*mctx).sub_tops as *mut libc::c_void);
    free((*mctx).bkref_ents as *mut libc::c_void);
}
unsafe extern "C" fn match_ctx_clean(mut mctx: *mut re_match_context_t) {
    ...
    while st_idx < (*mctx).nsub_tops {
        ...
        while sl_idx < (*top).nlasts {
            ...
            free((*last).path.array as *mut libc::c_void);
            free(last as *mut libc::c_void);
            sl_idx += 1;
            sl_idx;
        }
        free((*top).lasts as *mut libc::c_void);
        if !((*top).path).is_null() {
            free((*(*top).path).array as *mut libc::c_void);
            free((*top).path as *mut libc::c_void);
        }
    ...
    while idx <= (*pmatch.offset(0 as libc::c_int as isize)).rm_eo {
            ...
            || !fs.is_null() && re_node_set_contains(&mut eps_via_nodes, cur_node) != 0
        {
            ...
            if cur_node < 0 as libc::c_int as libc::c_long {
                free(eps_via_nodes.elems as *mut libc::c_void);
                regmatch_list_free(&mut prev_match);
...
unsafe extern "C" fn free_fail_stack_return(
    ...
    if !fs.is_null() {
        ...
        while fs_idx < (*fs).num {
            ...
            free((*((*fs).stack).offset(fs_idx as isize)).regs as *mut libc::c_void);
            fs_idx += 1;
            fs_idx;
        }
        free((*fs).stack as *mut libc::c_void);
    }
    return _REG_NOERROR;
}
unsafe extern "C" fn re_copy_regs(
    ...
    if regs_allocated == 0 as libc::c_int {
            ...
            != 0
        {
            ...
            if (new_end == 0 as *mut libc::c_void as *mut regoff_t) as libc::c_int
                as libc::c_long != 0
            {
                free(new_start as *mut libc::c_void);
                return 0 as libc::c_int as libc::c_uint;
            }
    ...
    while (i as libc::c_ulong) < (*regs).num_regs {
        let ref mut fresh57 = *((*regs).end).offset(i as isize);
        *fresh57 = -(1 as libc::c_int) as regoff_t;
        *((*regs).start).offset(i as isize) = *fresh57;
        i += 1;
        i;
    }
...
unsafe extern "C" fn push_fail_stack(
    ...
    let ref mut fresh59 = (*((*fs).stack).offset(num as isize)).regs;
    *fresh59 = malloc(
...
unsafe extern "C" fn re_search_internal(
        ...
        as libc::c_long != 0)
    {
            ...
            as libc::c_long != 0)
        {
                ...
                || (*dfa).has_mb_node() as libc::c_int != 0
            {
                ...
                {
                    err = _REG_ESPACE;
                    current_block = 18394677153799631766;
                } else {
                    mctx
                        .state_log = malloc(
                    ...
                    's_148: loop {
                        ...
                        match match_kind {
                            ...
                            7 => {
                                ...
                                current_block = 13190406431263401428;
                            }
                            6 => {
                                while (match_first < right_lim) as libc::c_int
                                    as libc::c_long != 0
                    ...
                    match current_block {
                        ...
                        _ => {
                            ...
                            if nmatch > 0 as libc::c_int as libc::c_ulong {
                                ...
                                while (reg_idx as libc::c_ulong) < nmatch {
                                    let ref mut fresh60 = (*pmatch.offset(reg_idx as isize))
                                        .rm_eo;
                                    *fresh60 = -(1 as libc::c_int) as regoff_t;
                                    (*pmatch.offset(reg_idx as isize)).rm_so = *fresh60;
                                    reg_idx += 1;
                                    reg_idx;
                                }
                                    ...
                                    _ => {
                                        ...
                                        while (reg_idx as libc::c_ulong) < nmatch {
                                                ...
                                                != -(1 as libc::c_int) as libc::c_long
                                            {
                                                ...
                                                let ref mut fresh61 = (*pmatch.offset(reg_idx as isize))
                                                    .rm_so;
                                                *fresh61 += match_first;
                                                let ref mut fresh62 = (*pmatch.offset(reg_idx as isize))
                                                    .rm_eo;
                                                *fresh62 += match_first;
                                            }
                                            reg_idx += 1;
    ...
    free(mctx.state_log as *mut libc::c_void);
    if (*dfa).nbackref != 0 {
...
unsafe extern "C" fn prune_impossible_nodes(
        ...
        as libc::c_int as libc::c_long != 0
    {
        ...
        if (*dfa).nbackref != 0 {
            ...
            {
                ret = _REG_ESPACE;
                current_block = 13201857192731968602;
            } else {
                's_62: loop {
                    memset(
                    ...
                    free(sctx.limits.elems as *mut libc::c_void);
                    if (ret as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
                        as libc::c_long != 0
                    {
                        current_block = 13201857192731968602;
                ...
                match current_block {
                    ...
                    _ => {
                        ...
                        free(lim_states as *mut libc::c_void);
    ...
    free(sifted_states as *mut libc::c_void);
    free(lim_states as *mut libc::c_void);
    return ret;
}
...
unsafe extern "C" fn sift_states_backward(
    ...
    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int as libc::c_long
        != 0
    {
        current_block = 9618447949483664340;
    } else {
    ...
    loop {
        match current_block {
            9618447949483664340 => {
                free(cur_dest.elems as *mut libc::c_void);
                break;
            }
            _ => {
            ...
            match current_block {
                ...
                _ => {
                    ...
                    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
                        as libc::c_long != 0
                    {
                        current_block = 6887377402636418981;
                        break;
                    }
                    ...
                    while bkc_idx < (*mctx).nbkref_ents {
                            ...
                            || (*bkref_ent).str_idx != cur_str_idx)
                        {
                            ...
                            if dest_state.is_null() {
                                let ref mut fresh64 = *((*mctx).state_log)
                                    .offset(dest_str_idx as isize);
                                *fresh64 = re_acquire_state_context(
                                    &mut err,
                                    dfa,
                                    new_dest_nodes,
                                    context,
                                ...
                                if (err as libc::c_int != _REG_NOERROR as libc::c_int)
                                    as libc::c_int as libc::c_long != 0
                                {
                                    free(dest_nodes.elems as *mut libc::c_void);
                                    current_block = 6887377402636418981;
                                    break 's_10;
                                } else {
            ...
            if !(sub_last_idx < (*sub_top).nlasts) {
                ...
                while sl_str <= bkref_str_idx {
                    ...
                    if sl_str_off > 0 as libc::c_int as libc::c_long {
                        ...
                        let fresh67 = bkref_str_off;
                        bkref_str_off = bkref_str_off + 1;
                        if *buf.offset(fresh67 as isize) as libc::c_int
                            != *buf
                                .offset(
...
unsafe extern "C" fn check_arrival(
    ...
    if str_idx == top_str {
        ...
        if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
            as libc::c_long != 0
        {
            free(next_nodes.elems as *mut libc::c_void);
            return err;
        }
    } else {
        ...
        || !cur_state.is_null() && (*cur_state).has_backref() as libc::c_int != 0
    {
        ...
        let ref mut fresh68 = *((*mctx).state_log).offset(str_idx as isize);
        *fresh68 = cur_state;
    }
    ...
    while str_idx < last_str && null_cnt <= (*mctx).max_mb_elem_len as libc::c_long {
        ...
        let ref mut fresh69 = *((*mctx).state_log).offset(str_idx as isize);
        *fresh69 = cur_state;
...
unsafe extern "C" fn merge_state_array(
    ...
    while st_idx < num {
        if (*dst.offset(st_idx as isize)).is_null() {
            let ref mut fresh70 = *dst.offset(st_idx as isize);
            *fresh70 = *src.offset(st_idx as isize);
            ...
            let ref mut fresh71 = *dst.offset(st_idx as isize);
            *fresh71 = re_acquire_state(&mut err, dfa, &mut merged_set);
            free(merged_set.elems as *mut libc::c_void);
            if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
                as libc::c_long != 0
            {
                return err;
...
unsafe extern "C" fn sift_states_bkref(
                            ...
                            ) as libc::c_int != 0)
                        {
                            if (local_sctx.sifted_states).is_null() {
                                ...
                                if (err as libc::c_int != _REG_NOERROR as libc::c_int)
                                    as libc::c_int as libc::c_long != 0
                                {
                                    current_block = 9675554404219745770;
                                    break 's_22;
                                }
                            }
                            ...
                            if !ok as libc::c_int as libc::c_long != 0 {
                                ...
                                let ref mut fresh72 = *(local_sctx.sifted_states)
                                    .offset(str_idx as isize);
                                *fresh72 = cur_state;
    ...
    if !(local_sctx.sifted_states).is_null() {
        free(local_sctx.limits.elems as *mut libc::c_void);
    }
    return err;
}
...
unsafe extern "C" fn transit_state(
    ...
    let fresh75 = (*mctx).input.cur_idx;
    (*mctx).input.cur_idx = (*mctx).input.cur_idx + 1;
    ch = *((*mctx).input.mbs).offset(fresh75 as isize);
    loop {
            ...
            if naccepted > 1 as libc::c_int {
                ...
                if !dest_state.is_null() {
                    ...
                    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
                        as libc::c_long != 0
                    {
                        free(union_set.elems as *mut libc::c_void);
                        return err;
                    }
                }
                ...
                let ref mut fresh76 = *((*mctx).state_log).offset(next_idx as isize);
...
unsafe extern "C" fn check_arrival_expand_ecl(
    ...
    while idx < (*cur_nodes).nelem {
        ...
        if outside_node == -(1 as libc::c_int) as libc::c_long {
            ...
            if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
                as libc::c_long != 0
            {
                free(new_nodes.elems as *mut libc::c_void);
                return err;
            }
        } else {
            err = check_arrival_expand_ecl_sub(
    ...
    free((*cur_nodes).elems as *mut libc::c_void);
    *cur_nodes = new_nodes;
    return _REG_NOERROR;
}
unsafe extern "C" fn merge_state_with_log(
    ...
    if cur_idx > (*mctx).state_log_top {
        let ref mut fresh77 = *((*mctx).state_log).offset(cur_idx as isize);
        *fresh77 = next_state;
        (*mctx).state_log_top = cur_idx;
    } else if (*((*mctx).state_log).offset(cur_idx as isize)).is_null() {
        let ref mut fresh78 = *((*mctx).state_log).offset(cur_idx as isize);
        *fresh78 = next_state;
    } else {
        ...
        let ref mut fresh79 = *((*mctx).state_log).offset(cur_idx as isize);
        *fresh79 = re_acquire_state_context(err, dfa, &mut next_nodes, context);
        next_state = *fresh79;
            ...
            if !(re_node_set_contains(cur_nodes, (*ent).node) == 0) {
                ...
                if to_idx == cur_str {
                    ...
                    if !(re_node_set_contains(cur_nodes, next_node) != 0) {
                        ...
                        free(new_dests.elems as *mut libc::c_void);
                        if (err as libc::c_int != _REG_NOERROR as libc::c_int
                    ...
                    match current_block {
                        ...
                        _ => {
                            let ref mut fresh80 = *((*mctx).state_log)
                                .offset(to_idx as isize);
                            *fresh80 = re_acquire_state(&mut err, dfa, &mut union_set);
                            free(union_set.elems as *mut libc::c_void);
                            if ((*((*mctx).state_log).offset(to_idx as isize)).is_null()
                                && err as libc::c_int != _REG_NOERROR as libc::c_int)
                                as libc::c_int as libc::c_long != 0
...
unsafe extern "C" fn build_trtable(
            ...
            while j < dests_node[i as usize].nelem {
                ...
                if next_node != -(1 as libc::c_int) as libc::c_long {
                    ...
                    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
                        as libc::c_long != 0
                    {
                        current_block = 4680748863823901935;
                        break 's_99;
                    }
                }
                j += 1;
            ...
            _ => {
                            ...
                            while elem != 0 {
                                    ...
                                    as libc::c_long != 0
                                {
                                    ...
                                    if (*dfa).word_char[i as usize] & mask != 0 {
                                        ...
                                        *fresh82 = dest_states_word[j as usize];
                                    } else {
                                        let ref mut fresh83 = *trtable.offset(ch as isize);
                                        *fresh83 = dest_states[j as usize];
                                    }
                                }
                                ...
                                / 64 as libc::c_int) as libc::c_long
                        {
                            ...
                            while elem != 0 {
                                    ...
                                    as libc::c_long != 0
                                {
                                    ...
                                    let ref mut fresh84 = *trtable.offset(ch as isize);
                                    *fresh84 = dest_states[j as usize];
                                    ...
                                    *fresh85 = dest_states_word[j as usize];
                                }
                                mask <<= 1 as libc::c_int;
                                elem >>= 1 as libc::c_int;
                                ch += 1;
                ...
                match current_block {
                    ...
                    _ => {
                        if bitset_contain(
                            ...
                            while j < ndests {
                                if bitset_contain(
                                    ...
                                    let ref mut fresh86 = *trtable.offset('\n' as i32 as isize);
                                    *fresh86 = dest_states_nl[j as usize];
                                    if need_word_trtable {
                                        let ref mut fresh87 = *trtable
                                            .offset(
                                                ('\n' as i32
                                                    + (127 as libc::c_int * 2 as libc::c_int + 1 as libc::c_int
                                                        + 1 as libc::c_int)) as isize,
                                            );
                                        *fresh87 = dest_states_nl[j as usize];
                                    }
                                    break;
                                } else {
                                    j += 1;
                        ...
                        free(follows.elems as *mut libc::c_void);
                        i = 0 as libc::c_int as Idx;
                        while i < ndests {
                            free(
    ...
    i = 0 as libc::c_int as Idx;
    while i < ndests {
        free((*dests_node.as_mut_ptr().offset(i as isize)).elems as *mut libc::c_void);
        i += 1;
        i;
    }
    return 0 as libc::c_int != 0;
    ...
    if (*node).type_0() as libc::c_int == COMPLEX_BRACKET as libc::c_int {
        ...
        loop {
            ...
            if wc == *((*cset).mbchars).offset(i as isize) {
                match_len = char_len;
                current_block = 12945044304289812852;
                break;
            } else {
                i += 1;
                i;
...
unsafe extern "C" fn group_nodes_into_DFAstates(
                                ...
                                if !(has_intersec == 0) {
                                    ...
                                    if not_subset != 0 {
                                        ...
                                        if (err as libc::c_int != _REG_NOERROR as libc::c_int)
                                            as libc::c_int as libc::c_long != 0
                                        {
                                            current_block = 15905081305426757356;
                                            break 's_20;
                                        }
                                        ndests += 1;
                                        ndests;
    ...
    match current_block {
        15905081305426757356 => {
            j = 0 as libc::c_int as Idx;
            while j < ndests {
                free((*dests_node.offset(j as isize)).elems as *mut libc::c_void);
                j += 1;
                j;
            }
            return -(1 as libc::c_int) as Idx;
...
unsafe extern "C" fn check_node_accept(
    ...
    match (*node).type_0() as libc::c_int {
        ...
        7 => {
            ...
            current_block_10 = 5260661489320506223;
        }
        5 => {
            current_block_10 = 5260661489320506223;
        }
...
unsafe extern "C" fn pop_fail_stack(
    ...
    *pidx = (*((*fs).stack).offset(num as isize)).idx;
    ...
    free((*eps_via_nodes).elems as *mut libc::c_void);
    free((*((*fs).stack).offset(num as isize)).regs as *mut libc::c_void);
                ...
                & 8 as libc::c_int != 0
            {
                        ...
                        && re_node_set_contains(dest_nodes, edst2) != 0
                {
                    ...
                    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
                        as libc::c_long != 0
                    {
                        free(except_nodes.elems as *mut libc::c_void);
                        return err;
                    }
                }
            }
