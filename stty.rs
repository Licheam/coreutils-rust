    ...
    if status != 0 as libc::c_int {
        ...
        printf(
            ...
            if tcsetattr_options == 1 as libc::c_int {
                gettext(b"on\0" as *const u8 as *const libc::c_char)
            } else {
                gettext(b"off\0" as *const u8 as *const libc::c_char)
            },
        );
        fputs_unlocked(
            gettext(
    ...
    if ch as libc::c_int >= 32 as libc::c_int {
        if (ch as libc::c_int) < 127 as libc::c_int {
            ...
            *fresh2 = '?' as i32 as libc::c_char;
            ...
            let fresh3 = bpout;
            bpout = bpout.offset(1);
            *fresh3 = 'M' as i32 as libc::c_char;
            let fresh4 = bpout;
            bpout = bpout.offset(1);
            *fresh4 = '-' as i32 as libc::c_char;
            if ch as libc::c_int >= 128 as libc::c_int + 32 as libc::c_int {
                if (ch as libc::c_int) < 128 as libc::c_int + 127 as libc::c_int {
                    let fresh5 = bpout;
                    bpout = bpout.offset(1);
                    *fresh5 = (ch as libc::c_int - 128 as libc::c_int) as libc::c_char;
                } else {
                    let fresh6 = bpout;
                    bpout = bpout.offset(1);
                ...
                *fresh8 = '^' as i32 as libc::c_char;
                let fresh9 = bpout;
                bpout = bpout.offset(1);
                *fresh9 = (ch as libc::c_int - 128 as libc::c_int + 64 as libc::c_int)
                    as libc::c_char;
            }
        }
    } else {
        ...
        *fresh10 = '^' as i32 as libc::c_char;
        let fresh11 = bpout;
        bpout = bpout.offset(1);
        *fresh11 = (ch as libc::c_int + 64 as libc::c_int) as libc::c_char;
    }
...
unsafe extern "C" fn integer_arg(
    ...
    return xnumtoumax(
        ...
        gettext(b"invalid integer argument\0" as *const u8 as *const libc::c_char),
        0 as libc::c_int,
    );
}
                ...
                if !match_found || not_set_attr as libc::c_int != 0 {
                        ...
                        == 0 as libc::c_int
                    {
                        ...
                        if !checking {
                            ...
                            *speed_was_set = 1 as libc::c_int != 0;
                            *require_set_attr = 1 as libc::c_int != 0;
                        }
                    } else if strcmp(
                        arg,
...
unsafe fn main_0(
    ...
    let mut speed_was_set: bool = false;
    ...
    loop {
        ...
        while opti < optind {
            let fresh12 = opti;
            opti = opti + 1;
            let ref mut fresh13 = *argv.offset((argi + fresh12) as isize);
    ...
    speed_was_set = 0 as libc::c_int != 0;
    ...
    if require_set_attr {
        ...
        {
            new_mode.c_cflag &= !(0o2003600000 as libc::c_int) as libc::c_uint;
            if speed_was_set as libc::c_int != 0
                || memcmp(
                    &mut mode as *mut termios as *const libc::c_void,
                    &mut new_mode as *mut termios as *const libc::c_void,
                    ::core::mem::size_of::<termios>() as libc::c_ulong,
                ) != 0 as libc::c_int
            {
                if ::core::mem::size_of::<C2RustUnnamed_4>() as libc::c_ulong != 0 {
                    error(
                        ...
                        0 as libc::c_int,
                        gettext(
                            b"%s: unable to perform all requested operations\0"
                                as *const u8 as *const libc::c_char,
                        ),
                        quotearg_n_style_colon(
                            0 as libc::c_int,
