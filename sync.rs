    ...
    if fd < 0 as libc::c_int {
        ...
        if fd < 0 as libc::c_int {
            error(
                0 as libc::c_int,
                rd_errno,
                gettext(b"error opening %s\0" as *const u8 as *const libc::c_char),
    ...
    if ret as libc::c_int == 1 as libc::c_int {
        ...
        match mode as libc::c_uint {
            ...
            _ => {
                ...
                'c_6929: {
                    ...
                    {} else {
                        __assert_fail(
                            b"\"invalid sync_mode\"\0" as *const u8
                                as *const libc::c_char,
                            b"src/sync.c\0" as *const u8 as *const libc::c_char,
                            152 as libc::c_int as libc::c_uint,
                            (*::core::mem::transmute::<
        ...
        if sync_status < 0 as libc::c_int {
            error(
                0 as libc::c_int,
                *__errno_location(),
                gettext(b"error syncing %s\0" as *const u8 as *const libc::c_char),
                quotearg_style(shell_escape_always_quoting_style, file),
            );
            ret = 0 as libc::c_int != 0;
        }
...
unsafe fn main_0(
    ...
    if mode as libc::c_uint == MODE_SYNC as libc::c_int as libc::c_uint {
        ...
        while optind < argc {
            ok = (ok as libc::c_int
                & sync_arg(mode, *argv.offset(optind as isize)) as libc::c_int) != 0;
            optind += 1;
            optind;
        }
    }
