...
pub const PRESUME_INPUT_PIPE_OPTION: C2RustUnnamed_0 = 128;
#[derive(Copy, Clone)]
#[repr(C)]
    ...
    match err as libc::c_uint {
        ...
        2 => {
            error(
                ...
                *__errno_location(),
                gettext(
                    b"%s: file has shrunk too much\0" as *const u8 as *const libc::c_char,
                ),
        ...
        loop {
            ...
            if n_read_0 < 8192 as libc::c_int as libc::c_ulong {
                if *__errno_location() != 0 as libc::c_int {
                    ...
                    ok = 0 as libc::c_int != 0;
                    current_block_69 = 18087376681648095104;
                    break;
                } else {
